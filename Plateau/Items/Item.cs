...
namespace Plateau.Items
{
    public class Item
    {
        public enum Tag
        {
            ...
            HAT, PANTS, SHOES, SOCKS, EARRINGS, SAILCLOTH, SHIRT, OUTERWEAR, BACK, GLASSES, GLOVES, ACCESSORY, SCARF, SKIN, HAIR, DYEABLE, MULTIDYE, NO_TRASH, EYES, ALWAYS_HIDE_HAIR, ALWAYS_SHOW_HAIR, HIDE_WHEN_HAT, DRAW_OVER_SHOES, FACIAL_HAIR,
            PLACEABLE,
