...
namespace Plateau.Items
{
    public class ItemDict
    {
        ...
        public static Item BLUE_DYE, NAVY_DYE, BLACK_DYE, RED_DYE, PINK_DYE, LIGHT_BROWN_DYE, DARK_BROWN_DYE, ORANGE_DYE, YELLOW_DYE, PURPLE_DYE, GREEN_DYE, OLIVE_DYE, WHITE_DYE, LIGHT_GREY_DYE, DARK_GREY_DYE, CYAN_DYE, CRIMSON_DYE, WHEAT_DYE, MINT_DYE, UN_DYE;
        ...
        private static ClothingItem MakeColoredVersion(ClothingItem item, RecolorMap recolor, string greyscaleItemIcon, string greyscaleTexture)
        {
            ...
            return new ClothingItem(name, item.GetTexturePath(), greyscaleItemIcon, item.GetStackCapacity(), item.GetRawDescription(), item.GetValue(), item.GetBaseSpritesheetPath(), greyscaleTexture, recolor, item.GetTags());
        }
        ...
        {
            string name = item.GetName() + (" (" + recolor.name + ")");
            return new BuildingBlockItem(name, item.GetTexturePath(), greyscaleItem, item.GetBasePlacedPath(), greyscaleSpritesheet, item.GetBlockType(), item.GetStackCapacity(), item.GetRawDescription(), item.GetValue(), recolor, item.GetTags());
        }
        ...
        public static void LoadContent(ContentManager content)
        {
            ...
            AddToDictionary(BLUE_DYE = new DyeItem("Blue Dye", Paths.ITEM_BLUE_DYE, DEFAULT_STACK_SIZE, Util.BLUE, "A liberating vial of blue colored dye. In your inventory, hold this and right click on clothes or furniture to apply it.", 100, Tag.DYE));
            AddToDictionary(NAVY_DYE = new DyeItem("Navy Dye", Paths.ITEM_NAVY_DYE, DEFAULT_STACK_SIZE, Util.NAVY, "An elegant vial of navy colored dye. In your inventory, hold this and right click on clothes or furniture to apply it.", 110, Tag.DYE));
            AddToDictionary(BLACK_DYE = new DyeItem("Black Dye", Paths.ITEM_BLACK_DYE, DEFAULT_STACK_SIZE, Util.BLACK, "A grievous vial of black colored dye. In your inventory, hold this and right click on clothes or furniture to apply it.", 120, Tag.DYE));
            AddToDictionary(RED_DYE = new DyeItem("Red Dye", Paths.ITEM_RED_DYE, DEFAULT_STACK_SIZE, Util.RED, "A bright vial of red colored dye. In your inventory, hold this and right click on clothes or furniture to apply it.", 100, Tag.DYE));
            AddToDictionary(PINK_DYE = new DyeItem("Pink Dye", Paths.ITEM_PINK_DYE, DEFAULT_STACK_SIZE, Util.PINK, "An ecstatic vial of pink colored dye. In your inventory, hold this and right click on clothes or furniture to apply it.", 1200, Tag.DYE, Tag.RARE));
            AddToDictionary(LIGHT_BROWN_DYE = new DyeItem("Light Brown Dye", Paths.ITEM_LIGHT_BROWN_DYE, DEFAULT_STACK_SIZE, Util.LIGHT_BROWN, "A steady vial of light brown colored dye. In your inventory, hold this and right click on clothes or furniture to apply it.", 100, Tag.DYE));
            AddToDictionary(DARK_BROWN_DYE = new DyeItem("Dark Brown Dye", Paths.ITEM_DARK_BROWN_DYE, DEFAULT_STACK_SIZE, Util.DARK_BROWN, "A tectonic vial of dark brown colored dye. In your inventory, hold this and right click on clothes or furniture to apply it.", 100, Tag.DYE));
            AddToDictionary(ORANGE_DYE = new DyeItem("Orange Dye", Paths.ITEM_ORANGE_DYE, DEFAULT_STACK_SIZE, Util.ORANGE, "An artistic vial of orange colored dye. In your inventory, hold this and right click on clothes or furniture to apply it.", 150, Tag.DYE));
            AddToDictionary(YELLOW_DYE = new DyeItem("Yellow Dye", Paths.ITEM_YELLOW_DYE, DEFAULT_STACK_SIZE, Util.YELLOW, "A regal vial of yellow colored dye. In your inventory, hold this and right click on clothes or furniture to apply it.", 120, Tag.DYE));
            AddToDictionary(PURPLE_DYE = new DyeItem("Purple Dye", Paths.ITEM_PURPLE_DYE, DEFAULT_STACK_SIZE, Util.PURPLE, "An imperial vial of purple colored dye. In your inventory, hold this and right click on clothes or furniture to apply it.", 125, Tag.DYE));
            AddToDictionary(GREEN_DYE = new DyeItem("Green Dye", Paths.ITEM_GREEN_DYE, DEFAULT_STACK_SIZE, Util.GREEN, "A vibrant vial of green colored dye. In your inventory, hold this and right click on clothes or furniture to apply it.", 75, Tag.DYE));
            AddToDictionary(OLIVE_DYE = new DyeItem("Olive Dye", Paths.ITEM_OLIVE_DYE, DEFAULT_STACK_SIZE, Util.OLIVE, "A distinguished vial of olive colored dye. In your inventory, hold this and right click on clothes or furniture to apply it.", 70, Tag.DYE));
            AddToDictionary(WHITE_DYE = new DyeItem("White Dye", Paths.ITEM_WHITE_DYE, DEFAULT_STACK_SIZE, Util.WHITE, "A classic vial of white colored dye. In your inventory, hold this and right click on clothes or furniture to apply it.", 130, Tag.DYE));
            AddToDictionary(LIGHT_GREY_DYE = new DyeItem("Light Grey Dye", Paths.ITEM_LIGHT_GREY_DYE, DEFAULT_STACK_SIZE, Util.LIGHT_GREY, "A timeless vial of light grey colored dye. In your inventory, hold this and right click on clothes or furniture to apply it.", 100, Tag.DYE));
            AddToDictionary(DARK_GREY_DYE = new DyeItem("Dark Grey Dye", Paths.ITEM_DARK_GREY_DYE, DEFAULT_STACK_SIZE, Util.DARK_GREY, "A futuristic vial of dark grey colored dye. In your inventory, hold this and right click on clothes or furniture to apply it.", 160, Tag.DYE));
            AddToDictionary(MINT_DYE = new DyeItem("Mint Dye", Paths.ITEM_MINT_DYE, DEFAULT_STACK_SIZE, Util.MINT, "A refreshing vial of mint colored dye. In your inventory, hold this and right click on clothes or furniture to apply it.", 160, Tag.DYE));
            AddToDictionary(WHEAT_DYE = new DyeItem("Wheat Dye", Paths.ITEM_WHEAT_DYE, DEFAULT_STACK_SIZE, Util.WHEAT, "An earthy vial of wheat colored dye. In your inventory, hold this and right click on clothes or furniture to apply it.", 125, Tag.DYE));
            AddToDictionary(CRIMSON_DYE = new DyeItem("Crimson Dye", Paths.ITEM_CRIMSON_DYE, DEFAULT_STACK_SIZE, Util.CRIMSON, "A sanguine vial of crimson colored dye. In your inventory, hold this and right click on clothes or furniture to apply it.", 110, Tag.DYE));
            AddToDictionary(CYAN_DYE = new DyeItem("Cyan Dye", Paths.ITEM_CYAN_DYE, DEFAULT_STACK_SIZE, Util.CYAN, "A techy vial of cyan colored dye. In your inventory, hold this and right click on clothes or furniture to apply it.", 280, Tag.DYE));
            AddToDictionary(UN_DYE = new DyeItem("Un-Dye", Paths.ITEM_UN_DYE, DEFAULT_STACK_SIZE, null, "A strange vial of dye-nullifying dye. In your inventory, hold this and right click on clothes or furniture to remove dye.", 125, Tag.DYE));
            ...
            AddToDictionary(SKY_STATUE = new PlaceableItem("Sky Statue", Paths.ITEM_SKY_STATUE, Paths.ITEM_SKY_STATUE, Paths.SPRITE_SKY_STATUE_SPRITESHEET, Paths.SPRITE_SKY_STATUE_SPRITESHEET, 2, 3, DEFAULT_STACK_SIZE, "This mythical statue allows you to teleport to other Sky Statues in the same area.", 1100, EntityType.SKY_STATUE, PlaceableItem.PlacementType.NORMAL, null, Item.Tag.DYEABLE, Item.Tag.PLACEABLE));
            AddToDictionary(DRACONIC_PILLAR = new PlaceableItem("Draconic Pillar", Paths.ITEM_DRACONIC_PILLAR, Paths.ITEM_DRACONIC_PILLAR, Paths.SPRITE_DRACONIC_PILLAR_SPRITESHEET, Paths.SPRITE_DRACONIC_PILLAR_SPRITESHEET, 2, 4, DEFAULT_STACK_SIZE, "An imposing structure. You can warp between placed Draconic Pillars regardless of distance.", 2400, EntityType.DRACONIC_PILLAR, PlaceableItem.PlacementType.NORMAL, null, Item.Tag.DYEABLE, Item.Tag.PLACEABLE));
            ...
            AddToDictionary(SYNTHESIZER = new PlaceableItem("Synthesizer", Paths.ITEM_SYNTHESIZER, Paths.ITEM_SYNTHESIZER, Paths.SPRITE_SYNTHESIZER_SPRITESHEET, Paths.SPRITE_SYNTHESIZER_SPRITESHEET, 2, 3, DEFAULT_STACK_SIZE, "This strange machine can create random objects from thin air!\nTry placing it in different areas!", 4300, EntityType.SYNTHESIZER, PlaceableItem.PlacementType.NORMAL, null, Item.Tag.DYEABLE, Item.Tag.PLACEABLE));
            ...
            AddToDictionary(CONCRETE_FLOOR = new PlaceableItem("Concrete Floor", Paths.ITEM_FLOOR_CONCRETE, Paths.ITEM_FLOOR_CONCRETE, Paths.SPRITE_FLOOR_CONCRETE, Paths.SPRITE_FLOOR_CONCRETE, 1,1, DEFAULT_STACK_SIZE, "Basic floor made of concrete.", 30, EntityType.FLOOR_DECOR, PlaceableItem.PlacementType.FLOOR, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            AddToDictionary(STREET_FLOOR = new PlaceableItem("Street Floor", Paths.ITEM_FLOOR_STREET, Paths.ITEM_FLOOR_STREET, Paths.SPRITE_FLOOR_STREET, Paths.SPRITE_FLOOR_STREET, 1,1, DEFAULT_STACK_SIZE, "But where're the cars?", 35, EntityType.FLOOR_DECOR, PlaceableItem.PlacementType.FLOOR, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            AddToDictionary(CARPET_FLOOR = new PlaceableItem("Carpet Floor", Paths.ITEM_FLOOR_CARPET, Paths.ITEM_FLOOR_CARPET, Paths.SPRITE_FLOOR_CARPET, Paths.SPRITE_FLOOR_CARPET, 1,1, DEFAULT_STACK_SIZE, "Some carpet for your floors. Try dying it different colors!", 25, EntityType.FLOOR_DECOR, PlaceableItem.PlacementType.FLOOR, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            AddToDictionary(BOARDWALK_FLOOR = new PlaceableItem("Boardwalk Floor", Paths.ITEM_FLOOR_BOARDWALK, Paths.ITEM_FLOOR_BOARDWALK, Paths.SPRITE_FLOOR_BOARDWALK, Paths.SPRITE_FLOOR_BOARDWALK, 1,1, DEFAULT_STACK_SIZE, "Not just for the beach.", 10, EntityType.FLOOR_DECOR, PlaceableItem.PlacementType.FLOOR, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            AddToDictionary(STEPPING_STONE_FLOOR = new PlaceableItem("Stepping Stone Floor", Paths.ITEM_FLOOR_STEPPING_STONE, Paths.ITEM_FLOOR_STEPPING_STONE, Paths.SPRITE_FLOOR_STEPPING_STONE, Paths.SPRITE_FLOOR_STEPPING_STONE, 1,1, DEFAULT_STACK_SIZE, "Commonly used to decorate gardens.", 15, EntityType.FLOOR_DECOR, PlaceableItem.PlacementType.FLOOR, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            AddToDictionary(WOODEN_FLOOR = new PlaceableItem("Wooden Floor", Paths.ITEM_FLOOR_WOODEN, Paths.ITEM_FLOOR_WOODEN, Paths.SPRITE_FLOOR_WOODEN, Paths.SPRITE_FLOOR_WOODEN, 1, 1, DEFAULT_STACK_SIZE, "Simple flooring made from wood.", 15, EntityType.FLOOR_DECOR, PlaceableItem.PlacementType.FLOOR, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            AddToDictionary(TATAMI_FLOOR = new PlaceableItem("Tatami Floor", Paths.ITEM_FLOOR_TATAMI, Paths.ITEM_FLOOR_TATAMI, Paths.SPRITE_FLOOR_TATAMI, Paths.SPRITE_FLOOR_TATAMI, 1, 1, DEFAULT_STACK_SIZE, "A flooring mat woven from bamboo.", 10, EntityType.FLOOR_DECOR, PlaceableItem.PlacementType.FLOOR, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            AddToDictionary(THIN_TATAMI_FLOOR = new PlaceableItem("Thin Tatami Floor", Paths.ITEM_FLOOR_THIN_TATAMI, Paths.ITEM_FLOOR_THIN_TATAMI, Paths.SPRITE_FLOOR_THIN_TATAMI, Paths.SPRITE_FLOOR_THIN_TATAMI, 1, 1, DEFAULT_STACK_SIZE, "Like normal tatami, but thin.", 8, EntityType.FLOOR_DECOR, PlaceableItem.PlacementType.FLOOR, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            AddToDictionary(MAT_FLOOR = new PlaceableItem("Mat Floor", Paths.ITEM_FLOOR_MAT, Paths.ITEM_FLOOR_MAT, Paths.SPRITE_FLOOR_MAT, Paths.SPRITE_FLOOR_MAT, 1, 1, DEFAULT_STACK_SIZE, "A thin cloth mat that can be used to decorate floors.", 40, EntityType.FLOOR_DECOR, PlaceableItem.PlacementType.FLOOR, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            AddToDictionary(FOOTPRINT_FLOOR = new PlaceableItem("Footprint Floor", Paths.ITEM_FLOOR_FOOTPRINT, Paths.ITEM_FLOOR_FOOTPRINT, Paths.SPRITE_FLOOR_FOOTPRINT, Paths.SPRITE_FLOOR_FOOTPRINT, 1, 1, DEFAULT_STACK_SIZE, "Oops...", 5, EntityType.FLOOR_DECOR, PlaceableItem.PlacementType.FLOOR, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            AddToDictionary(TRIANGULATE_FLOOR = new PlaceableItem("Triangulate Floor", Paths.ITEM_FLOOR_TRIANGULATE, Paths.ITEM_FLOOR_TRIANGULATE, Paths.SPRITE_FLOOR_TRIANGULATE, Paths.SPRITE_FLOOR_TRIANGULATE, 1, 1, DEFAULT_STACK_SIZE, "A strange flooring pattern, perhaps used to signal to aliens?", 61, EntityType.FLOOR_DECOR, PlaceableItem.PlacementType.FLOOR, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            AddToDictionary(SQUARE_FLOOR = new PlaceableItem("Square Floor", Paths.ITEM_FLOOR_SQUARE, Paths.ITEM_FLOOR_SQUARE, Paths.SPRITE_FLOOR_SQUARE, Paths.SPRITE_FLOOR_SQUARE, 1, 1, DEFAULT_STACK_SIZE, "Fancy stepping stones roughly cut into square parts.", 25, EntityType.FLOOR_DECOR, PlaceableItem.PlacementType.FLOOR, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE,  Item.Tag.PLACEABLE));
            ...
            AddToDictionary(MYTHRIL_FENCE = new PlaceableItem("Mythril Fence", Paths.ITEM_MYTHRIL_FENCE, Paths.ITEM_MYTHRIL_FENCE, Paths.SPRITE_MYTHRIL_FENCE_SPRITESHEET, Paths.SPRITE_MYTHRIL_FENCE_SPRITESHEET, 1, 2, DEFAULT_STACK_SIZE, "Quintessential fencing made of mythril. Place fences adjacent to each other for best results.", 
                50, EntityType.FENCE, PlaceableItem.PlacementType.NORMAL, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            AddToDictionary(METAL_FENCE = new PlaceableItem("Metal Fence", Paths.ITEM_METAL_FENCE, Paths.ITEM_METAL_FENCE, Paths.SPRITE_METAL_FENCE_SPRITESHEET, Paths.SPRITE_METAL_FENCE_SPRITESHEET, 1, 1, DEFAULT_STACK_SIZE, "Inelastic fencing made of iron. If you place them side by side they'll expand.",
                30, EntityType.FENCE, PlaceableItem.PlacementType.NORMAL, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            AddToDictionary(STONE_FENCE = new PlaceableItem("Stone Fence", Paths.ITEM_STONE_FENCE, Paths.ITEM_STONE_FENCE, Paths.SPRITE_STONE_FENCE_SPRITESHEET, Paths.SPRITE_STONE_FENCE_SPRITESHEET, 1, 2, DEFAULT_STACK_SIZE, "Gorgonic fencing made of stone. Good fences make good neighbors.",
                10, EntityType.FENCE, PlaceableItem.PlacementType.NORMAL, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            AddToDictionary(WOODEN_FENCE = new PlaceableItem("Wooden Fence", Paths.ITEM_WOODEN_FENCE, Paths.ITEM_WOODEN_FENCE, Paths.SPRITE_WOODEN_FENCE_SPRITESHEET, Paths.SPRITE_WOODEN_FENCE_SPRITESHEET, 1, 1, DEFAULT_STACK_SIZE, "Rural fencing made of wood. Place multiple!",
                5, EntityType.FENCE, PlaceableItem.PlacementType.NORMAL, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            AddToDictionary(TALL_FENCE = new PlaceableItem("Tall Fence", Paths.ITEM_TALL_FENCE, Paths.ITEM_TALL_FENCE, Paths.SPRITE_TALL_FENCE_SPRITESHEET, Paths.SPRITE_TALL_FENCE_SPRITESHEET, 1, 3, DEFAULT_STACK_SIZE, "Towering fencing made of wood. Privacy restored!",
                15, EntityType.FENCE, PlaceableItem.PlacementType.NORMAL, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            AddToDictionary(GOLDEN_FENCE = new PlaceableItem("Golden Fence", Paths.ITEM_GOLDEN_FENCE, Paths.ITEM_GOLDEN_FENCE, Paths.SPRITE_GOLDEN_FENCE_SPRITESHEET, Paths.SPRITE_GOLDEN_FENCE_SPRITESHEET, 1, 2, DEFAULT_STACK_SIZE, "Midasian fencing made of gold. A bit gaudy, perhaps?",
                60, EntityType.FENCE, PlaceableItem.PlacementType.NORMAL, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            ...
            AddToDictionary(HELIX_POSTER = new PlaceableItem("Helix Poster", Paths.ITEM_HELIX_POSTER, Paths.ITEM_HELIX_POSTER, Paths.SPRITE_HELIX_POSTER_SPRITESHEET, Paths.SPRITE_HELIX_POSTER_SPRITESHEET,
                2, 4, DEFAULT_STACK_SIZE, "It's a picture of deoxyribonucleic acid.", 2800, EntityType.WALL_DECOR, PlaceableItem.PlacementType.WALL, null, Tag.DYEABLE, Item.Tag.PLACEABLE));
            ...
            AddToDictionary(SMILE_GRAFFITI = new PlaceableItem("Smile Graffiti", Paths.ITEM_SMILE_GRAFFITI, Paths.ITEM_SMILE_GRAFFITI, Paths.SPRITE_SMILE_GRAFFITI_SPRITESHEET, Paths.SPRITE_SMILE_GRAFFITI_SPRITESHEET,
                2, 2, DEFAULT_STACK_SIZE, "It's just a smile, see? Nothing to see here.", 2000, EntityType.WALL_DECOR, PlaceableItem.PlacementType.WALL, null, Tag.DYEABLE, Item.Tag.PLACEABLE));
            ...
            AddToDictionary(SURFBOARD = new PlaceableItem("Surfboard", Paths.ITEM_SURFBOARD, Paths.ITEM_SURFBOARD, Paths.SPRITE_SURFBOARD_SPRITESHEET, Paths.SPRITE_SURFBOARD_SPRITESHEET,
                2, 4, DEFAULT_STACK_SIZE, "Surf's up, dude!", 1900, EntityType.DECOR, PlaceableItem.PlacementType.NORMAL, null, Tag.DYEABLE, Item.Tag.PLACEABLE));
            ...
            AddToDictionary(PAINTING_RESONANT = new PlaceableItem("\"Resonant\"", Paths.ITEM_PAINTING_RESONANT, Paths.ITEM_PAINTING_RESONANT, Paths.SPRITE_PAINTING_RESONANT_SPRITESHEET, Paths.SPRITE_PAINTING_RESONANT_SPRITESHEET,
                6, 7, 1, "Painting #51 of 50\nHow does it feel to be on the top, looking down?\nThank you for playing Plateau.\n-B", 800000000, EntityType.WALL_DECOR, PlaceableItem.PlacementType.WALL, null, Tag.DYEABLE, Item.Tag.PLACEABLE));
            ...
            AddToDictionary(WAVE_WALLPAPER = new WallpaperItem("Wave Wallpaper", Paths.ITEM_WALLPAPER_WAVE, Paths.ITEM_WALLPAPER_WAVE,
                ...
                1, 1, DEFAULT_STACK_SIZE, "Do the wave!", 80, EntityType.WALLPAPER, PlaceableItem.PlacementType.WALLPAPER, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            AddToDictionary(STAR_WALLPAPER = new WallpaperItem("Star Wallpaper", Paths.ITEM_WALLPAPER_STAR, Paths.ITEM_WALLPAPER_STAR,
                ...
                Paths.SPRITE_WALLPAPER_STAR, Paths.SPRITE_WALLPAPER_STAR,
                Paths.SPRITE_WALLPAPER_STAR, Paths.SPRITE_WALLPAPER_STAR,
                1, 1, DEFAULT_STACK_SIZE, "One small step for man, one giant leap for your walls.", 50, EntityType.WALLPAPER, PlaceableItem.PlacementType.WALLPAPER, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            AddToDictionary(BUBBLE_WALLPAPER = new WallpaperItem("Bubble Wallpaper", Paths.ITEM_WALLPAPER_BUBBLE, Paths.ITEM_WALLPAPER_BUBBLE, 
                ...
                Paths.SPRITE_WALLPAPER_BUBBLE, Paths.SPRITE_WALLPAPER_BUBBLE,
                Paths.SPRITE_WALLPAPER_BUBBLE, Paths.SPRITE_WALLPAPER_BUBBLE,
                1, 1, DEFAULT_STACK_SIZE, "It makes you feel like you're underwater!", 40, EntityType.WALLPAPER, PlaceableItem.PlacementType.WALLPAPER, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            AddToDictionary(SOLID_WALLPAPER = new WallpaperItem("Solid Wallpaper", Paths.ITEM_WALLPAPER_SOLID, Paths.ITEM_WALLPAPER_SOLID,
                ...
                1, 1, DEFAULT_STACK_SIZE, "A roll of basic solid colored wallpaper.", 25, EntityType.WALLPAPER, PlaceableItem.PlacementType.WALLPAPER, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            AddToDictionary(VERTICAL_WALLPAPER = new WallpaperItem("Vertical Wallpaper", Paths.ITEM_WALLPAPER_VERTICAL, Paths.ITEM_WALLPAPER_VERTICAL,
                ...
                1, 1, DEFAULT_STACK_SIZE, "A roll of vertically striped wallpaper.", 40, EntityType.WALLPAPER, PlaceableItem.PlacementType.WALLPAPER, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            AddToDictionary(HORIZONTAL_WALLPAPER = new WallpaperItem("Horizontal Wallpaper", Paths.ITEM_WALLPAPER_HORIZONTAL, Paths.ITEM_WALLPAPER_HORIZONTAL,
                ...
                1, 1, DEFAULT_STACK_SIZE, "It's exactly what it says on the tin.", 45, EntityType.WALLPAPER, PlaceableItem.PlacementType.WALLPAPER, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            AddToDictionary(DOT_WALLPAPER = new WallpaperItem("Dot Wallpaper", Paths.ITEM_WALLPAPER_DOT, Paths.ITEM_WALLPAPER_DOT,
                ...
                1, 1, DEFAULT_STACK_SIZE, "This wallpaper doesn't take Damage Over Time in any way. It's long lasting!", 45, EntityType.WALLPAPER, PlaceableItem.PlacementType.WALLPAPER, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            AddToDictionary(POLKA_WALLPAPER = new WallpaperItem("Polka Wallpaper", Paths.ITEM_WALLPAPER_POLKA, Paths.ITEM_WALLPAPER_POLKA,
                ...
                1, 1, DEFAULT_STACK_SIZE, "Do the dance!", 45, EntityType.WALLPAPER, PlaceableItem.PlacementType.WALLPAPER, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            AddToDictionary(INVADER_WALLPAPER = new WallpaperItem("Invader Wallpaper", Paths.ITEM_WALLPAPER_INVADER, Paths.ITEM_WALLPAPER_INVADER,
                ...
                1, 1, DEFAULT_STACK_SIZE, "Modeled after retro arcade games.", 45, EntityType.WALLPAPER, PlaceableItem.PlacementType.WALLPAPER, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            AddToDictionary(ODD_WALLPAPER = new WallpaperItem("Odd Wallpaper", Paths.ITEM_WALLPAPER_ODD, Paths.ITEM_WALLPAPER_ODD,
                ...
                Paths.SPRITE_WALLPAPER_ODD, Paths.SPRITE_WALLPAPER_ODD,
                Paths.SPRITE_WALLPAPER_ODD, Paths.SPRITE_WALLPAPER_ODD,
                1, 1, DEFAULT_STACK_SIZE, "What is this pattern even supposed to be?", 35, EntityType.WALLPAPER, PlaceableItem.PlacementType.WALLPAPER, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            ...
            AddToDictionary(RUCKSACK = new ClothingItem("Rucksack", Paths.ITEM_RUCKSACK, Paths.ITEM_RUCKSACK, 1,"The small size makes it popular for shorter outings.", 450, Paths.CLOTHING_RUCKSACK_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.BACK, Item.Tag.DYEABLE, Item.Tag.CLOTHING));
            AddToDictionary(CAPE = new ClothingItem("Cape", Paths.ITEM_CAPE, Paths.ITEM_CAPE, 1,"For superheroes only.", 1250, Paths.CLOTHING_CAPE_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.BACK, Item.Tag.DYEABLE, Item.Tag.CLOTHING));
            AddToDictionary(GUITAR = new ClothingItem("Guitar", Paths.ITEM_GUITAR, Paths.ITEM_GUITAR, 1, "Worn on the back. Now all you need is a campfire.", 1700, Paths.CLOTHING_GUITAR_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.BACK, Item.Tag.DYEABLE, Item.Tag.CLOTHING));
            AddToDictionary(WOLF_TAIL = new ClothingItem("Wolf Tail", Paths.ITEM_WOLF_TAIL, Paths.ITEM_WOLF_TAIL, 1,"A tail for those who howl at the moon.", 800, Paths.CLOTHING_WOLF_TAIL_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.BACK, Item.Tag.DYEABLE, Item.Tag.CLOTHING));
            AddToDictionary(FOX_TAIL = new ClothingItem("Fox Tail", Paths.ITEM_FOX_TAIL, Paths.ITEM_FOX_TAIL, 1,"Also usable as a paintbrush.", 1000, Paths.CLOTHING_FOX_TAIL_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.BACK, Item.Tag.DYEABLE, Item.Tag.CLOTHING));
            AddToDictionary(CAT_TAIL = new ClothingItem("Cat Tail", Paths.ITEM_CAT_TAIL, Paths.ITEM_CAT_TAIL, 1,"A decorative tail which resembles that of a feline.", 800, Paths.CLOTHING_CAT_TAIL_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.BACK, Item.Tag.DYEABLE, Item.Tag.CLOTHING));
            AddToDictionary(CLOCKWORK = new ClothingItem("Clockwork", Paths.ITEM_CLOCKWORK, Paths.ITEM_CLOCKWORK, 1,"Tick... tock... tick... tock...", 2200, Paths.CLOTHING_CLOCKWORK_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.BACK, Item.Tag.DYEABLE, Item.Tag.CLOTHING));
            AddToDictionary(ROBO_ARMS = new ClothingItem("Robo-Arms", Paths.ITEM_ROBO_ARMS, Paths.ITEM_ROBO_ARMS, 1,"They called me crazy, but who's the mad scientist now?", 3600, Paths.CLOTHING_ROBO_ARMS_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.BACK, Item.Tag.DYEABLE, Item.Tag.CLOTHING));

            AddToDictionary(EARRING_STUD = new ClothingItem("Earring Stud", Paths.ITEM_EARRING_STUD, Paths.ITEM_EARRING_STUD, 1,"It's been working out.", 300, Paths.CLOTHING_EARRING_STUD_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.EARRINGS, Item.Tag.DYEABLE, Item.Tag.CLOTHING));
            AddToDictionary(DANGLE_EARRING = new ClothingItem("Dangle Earring", Paths.ITEM_DANGLE_EARRING, Paths.ITEM_DANGLE_EARRING, 1,"It dangles a little, see?", 620, Paths.CLOTHING_DANGLE_EARRING_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.EARRINGS, Item.Tag.DYEABLE, Item.Tag.CLOTHING));
            AddToDictionary(PIERCING = new ClothingItem("Piercing", Paths.ITEM_PIERCING, Paths.ITEM_PIERCING, 1,"Straight through the heart.", 530, Paths.CLOTHING_PIERCING_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.EARRINGS, Item.Tag.DYEABLE, Item.Tag.CLOTHING));

            AddToDictionary(GLASSES = new ClothingItem("Glasses", Paths.ITEM_GLASSES, Paths.ITEM_GLASSES, 1,"These'll help you see!", 500, Paths.CLOTHING_GLASSES_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.GLASSES, Item.Tag.DYEABLE, Item.Tag.CLOTHING));
            AddToDictionary(BLINDFOLD = new ClothingItem("Blindfold", Paths.ITEM_BLINDFOLD, Paths.ITEM_BLINDFOLD, 1,"There is nothing outside, and nothing within.", 550, Paths.CLOTHING_BLINDFOLD_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.GLASSES, Item.Tag.DYEABLE, Item.Tag.CLOTHING));
            AddToDictionary(EYEPATCH = new ClothingItem("Eyepatch", Paths.ITEM_EYEPATCH, Paths.ITEM_EYEPATCH, 1,"This is what happens when you run with shears.", 450, Paths.CLOTHING_EYEPATCH_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.GLASSES, Item.Tag.DYEABLE, Item.Tag.CLOTHING));
            AddToDictionary(GOGGLES = new ClothingItem("Goggles", Paths.ITEM_GOGGLES, Paths.ITEM_GOGGLES, 1,"Gogo Goggles!", 900, Paths.CLOTHING_GOGGLES_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.GLASSES, Item.Tag.DYEABLE, Item.Tag.CLOTHING));
            AddToDictionary(PROTECTIVE_VISOR = new ClothingItem("Protective Visor", Paths.ITEM_PROTECTIVE_VISOR, Paths.ITEM_PROTECTIVE_VISOR, 1,"Just in case...", 950, Paths.CLOTHING_PROTECTIVE_VISOR_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.GLASSES, Item.Tag.DYEABLE, Item.Tag.CLOTHING));
            AddToDictionary(QUERADE_MASK = new ClothingItem("Querade Mask", Paths.ITEM_QUERADE_MASK, Paths.ITEM_QUERADE_MASK, 1,"Exquisitely suited for a midnight ball.", 950, Paths.CLOTHING_QUERADE_MASK_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.GLASSES, Item.Tag.DYEABLE, Item.Tag.CLOTHING));
            AddToDictionary(SNORKEL = new ClothingItem("Snorkel", Paths.ITEM_SNORKEL, Paths.ITEM_SNORKEL, 1,"Doesn't work without an oxygen tank...", 2300, Paths.CLOTHING_SNORKEL_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.GLASSES, Item.Tag.DYEABLE, Item.Tag.CLOTHING));
            AddToDictionary(SUNGLASSES = new ClothingItem("Sunglasses", Paths.ITEM_SUNGLASSES, Paths.ITEM_SUNGLASSES, 1,"Too cool for school.", 1000, Paths.CLOTHING_SUNGLASSES_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.GLASSES, Item.Tag.DYEABLE, Item.Tag.CLOTHING));

            AddToDictionary(WOOL_MITTENS = new ClothingItem("Wool Mittens", Paths.ITEM_WOOL_MITTENS, Paths.ITEM_WOOL_MITTENS, 1,"Woven with love. This will keep your hands warm.", 330, Paths.CLOTHING_WOOL_MITTENS_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.GLOVES, Item.Tag.DYEABLE, Item.Tag.CLOTHING));
            AddToDictionary(WORK_GLOVES = new ClothingItem("Work Gloves", Paths.ITEM_WORK_GLOVES, Paths.ITEM_WORK_GLOVES, 1,"Rough and tough. Built to last.", 430, Paths.CLOTHING_WORK_GLOVES_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.GLOVES, Item.Tag.DYEABLE, Item.Tag.CLOTHING));
            AddToDictionary(BOXING_MITTS = new ClothingItem("Boxing Mitts", Paths.ITEM_BOXING_MITTS, Paths.ITEM_BOXING_MITTS, 1,"You ain't no air fighter, Mac!", 900, Paths.CLOTHING_BOXING_MITTS_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.GLOVES, Item.Tag.DYEABLE, Item.Tag.CLOTHING));
            
            AddToDictionary(BASEBALL_CAP = new ClothingItem("Baseball Cap", Paths.ITEM_BASEBALL_CAP, Paths.ITEM_BASEBALL_CAP, 1,"Great for casual wear.", 500, Paths.CLOTHING_BASEBALL_CAP_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.HAT, Item.Tag.DYEABLE, Item.Tag.CLOTHING));
            AddToDictionary(TEN_GALLON = new ClothingItem("10 Gallon", Paths.ITEM_10_GALLON, Paths.ITEM_10_GALLON, 1,"This one has a mild defect. It's actually 11 gallons.", 350, Paths.CLOTHING_10_GALLON_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.HAT, Item.Tag.DYEABLE, Item.Tag.CLOTHING));
            AddToDictionary(BANDANA = new ClothingItem("Bandana", Paths.ITEM_BANDANA, Paths.ITEM_BANDANA, 1,"Aye matey, I be doing the yardwork now!", 650, Paths.CLOTHING_BANDANA_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.HAT, Item.Tag.DYEABLE, Item.Tag.CLOTHING, Item.Tag.ALWAYS_HIDE_HAIR));
            AddToDictionary(BOWLER = new ClothingItem("Bowler", Paths.ITEM_BOWLER, Paths.ITEM_BOWLER, 1,"What do you think, detective?", 950, Paths.CLOTHING_BOWLER_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.HAT, Item.Tag.DYEABLE, Item.Tag.CLOTHING));
            AddToDictionary(BUNNY_EARS = new ClothingItem("Bunny Ears", Paths.ITEM_BUNNY_EARS, Paths.ITEM_BUNNY_EARS, 1,"You feel a strange desire for carrots...", 3200, Paths.CLOTHING_BUNNY_EARS_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.HAT, Item.Tag.DYEABLE, Item.Tag.CLOTHING, Item.Tag.ALWAYS_SHOW_HAIR));
            AddToDictionary(CAT_EARS = new ClothingItem("Cat Ears", Paths.ITEM_CAT_EARS, Paths.ITEM_CAT_EARS, 1,"Meow!", 1700, Paths.CLOTHING_CAT_EARS_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.HAT, Item.Tag.DYEABLE, Item.Tag.CLOTHING, Item.Tag.ALWAYS_SHOW_HAIR));
            AddToDictionary(BUTTERFLY_CLIP = new ClothingItem("Butterfly Clip", Paths.ITEM_BUTTERFLY_CLIP, Paths.ITEM_BUTTERFLY_CLIP, 1,"It resembles a butterfly. How quaint!", 100, Paths.CLOTHING_BUTTERFLY_CLIP_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.HAT, Item.Tag.DYEABLE, Item.Tag.CLOTHING, Item.Tag.ALWAYS_SHOW_HAIR));
            AddToDictionary(CAMEL_HAT = new ClothingItem("Camel Hat", Paths.ITEM_CAMEL_HAT, Paths.ITEM_CAMEL_HAT, 1,"Named for the distinctive hump.", 600, Paths.CLOTHING_CAMEL_HAT_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.HAT, Item.Tag.DYEABLE, Item.Tag.CLOTHING));
            AddToDictionary(CHEFS_HAT = new ClothingItem("Chefs Hat", Paths.ITEM_CHEFS_HAT, Paths.ITEM_CHEFS_HAT, 1,"Required for entry into any respectable cooking guild.", 2950, Paths.CLOTHING_CHEFS_HAT_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.HAT, Item.Tag.DYEABLE, Item.Tag.CLOTHING));
            AddToDictionary(CONICAL_FARMER = new ClothingItem("Conical Farmer", Paths.ITEM_CONICAL_FARMER, Paths.ITEM_CONICAL_FARMER, 1,"Complete protection from the blistering sun!", 400, Paths.CLOTHING_CONICAL_FARMER_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.HAT, Item.Tag.DYEABLE, Item.Tag.CLOTHING));
            AddToDictionary(DINO_MASK = new ClothingItem("Dino Mask", Paths.ITEM_DINO_MASK, Paths.ITEM_DINO_MASK, 1,"That belongs in a museum!", 3200, Paths.CLOTHING_DINO_MASK_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.HAT, Item.Tag.DYEABLE, Item.Tag.CLOTHING, Item.Tag.ALWAYS_HIDE_HAIR));
            AddToDictionary(DOG_MASK = new ClothingItem("Dog Mask", Paths.ITEM_DOG_MASK, Paths.ITEM_DOG_MASK, 1,"Who let the dogs out?", 1600, Paths.CLOTHING_DOG_MASK_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.HAT, Item.Tag.DYEABLE, Item.Tag.CLOTHING, Item.Tag.ALWAYS_HIDE_HAIR));
            AddToDictionary(FACEMASK = new ClothingItem("Facemask", Paths.ITEM_FACEMASK, Paths.ITEM_FACEMASK, 1,"You never know when you might be the lone survivor. Or when you'll need to do field surgery.", 900, Paths.CLOTHING_FACEMASK_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.HAT, Item.Tag.DYEABLE, Item.Tag.CLOTHING, Item.Tag.ALWAYS_SHOW_HAIR));
            AddToDictionary(FLAT_CAP = new ClothingItem("Flat Cap", Paths.ITEM_FLAT_CAP, Paths.ITEM_FLAT_CAP, 1,"You know Professor, this reminds me of a perculiar puzzle...", 1000, Paths.CLOTHING_FLAT_CAP_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.HAT, Item.Tag.DYEABLE, Item.Tag.CLOTHING));
            AddToDictionary(HEADBAND = new ClothingItem("Headband", Paths.ITEM_HEADBAND, Paths.ITEM_HEADBAND, 1,"Burn those calories!", 500, Paths.CLOTHING_HEADBAND_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.HAT, Item.Tag.DYEABLE, Item.Tag.CLOTHING, Item.Tag.ALWAYS_SHOW_HAIR));
            AddToDictionary(NIGHTCAP = new ClothingItem("Nightcap", Paths.ITEM_NIGHTCAP, Paths.ITEM_NIGHTCAP, 1,"Spin attack, go! Sleep attack, activate!", 1000, Paths.CLOTHING_NIGHTCAP_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.HAT, Item.Tag.DYEABLE, Item.Tag.CLOTHING));
            AddToDictionary(NIGHTMARE_MASK = new ClothingItem("Nightmare Mask", Paths.ITEM_NIGHTMARE_MASK, Paths.ITEM_NIGHTMARE_MASK, 1,"Not recommended for wear near lakes or elm trees.", 950, Paths.CLOTHING_NIGHTMARE_MASK_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.HAT, Item.Tag.DYEABLE, Item.Tag.CLOTHING));
            AddToDictionary(SNAPBACK = new ClothingItem("Snapback", Paths.ITEM_SNAPBACK, Paths.ITEM_SNAPBACK, 1,"Take that, and snap it back!", 750, Paths.CLOTHING_SNAPBACK_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.HAT, Item.Tag.DYEABLE, Item.Tag.CLOTHING));
            AddToDictionary(SQUARE_HAT = new ClothingItem("Square Hat", Paths.ITEM_SQUARE_HAT, Paths.ITEM_SQUARE_HAT, 1,"Doesn't make the wearer better at dancing, sadly.", 900, Paths.CLOTHING_SQUARE_HAT_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.HAT, Item.Tag.DYEABLE, Item.Tag.CLOTHING));
            AddToDictionary(STRAW_HAT = new ClothingItem("Straw Hat", Paths.ITEM_STRAW_HAT, Paths.ITEM_STRAW_HAT, 1,"The hat that broke the camel's back.", 580, Paths.CLOTHING_STRAW_HAT_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.HAT, Item.Tag.DYEABLE, Item.Tag.CLOTHING));
            AddToDictionary(TOP_HAT = new ClothingItem("Top Hat", Paths.ITEM_TOP_HAT, Paths.ITEM_TOP_HAT, 1,"Fit for a magically refined gentleman.", 1250, Paths.CLOTHING_TOP_HAT_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.HAT, Item.Tag.DYEABLE, Item.Tag.CLOTHING));
            AddToDictionary(TRACE_TATTOO = new ClothingItem("Trace Tattoo", Paths.ITEM_TRACE_TATTOO, Paths.ITEM_TRACE_TATTOO, 1,"A strange removable tattoo. It may hold an unknown power.", 1800, Paths.CLOTHING_TRACE_TATTOO_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.HAT, Item.Tag.DYEABLE, Item.Tag.CLOTHING, Item.Tag.ALWAYS_SHOW_HAIR));
            AddToDictionary(WHISKERS = new ClothingItem("Whiskers", Paths.ITEM_WHISKERS, Paths.ITEM_WHISKERS, 1,"Meeeoooow!", 2000, Paths.CLOTHING_WHISKERS_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.HAT, Item.Tag.DYEABLE, Item.Tag.CLOTHING, Item.Tag.ALWAYS_SHOW_HAIR));

            AddToDictionary(SCARF = new ClothingItem("Scarf", Paths.ITEM_SCARF, Paths.ITEM_SCARF, 1,"A shield against the winter cold.", 620, Paths.CLOTHING_SCARF_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.SCARF, Item.Tag.DYEABLE, Item.Tag.CLOTHING));
            AddToDictionary(ASCOT = new ClothingItem("Ascot", Paths.ITEM_ASCOT, Paths.ITEM_ASCOT, 1,"Fancy!", 675, Paths.CLOTHING_ASCOT_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.SCARF, Item.Tag.DYEABLE, Item.Tag.CLOTHING));
            AddToDictionary(MEDAL = new ClothingItem("Medal", Paths.ITEM_MEDAL, Paths.ITEM_MEDAL, 1,"Sweet, sweet victory. (Yeah!)", 1500, Paths.CLOTHING_MEDAL_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.SCARF, Item.Tag.DYEABLE, Item.Tag.CLOTHING));
            AddToDictionary(NECKWARMER = new ClothingItem("Neckwarmer", Paths.ITEM_NECKWARMER, Paths.ITEM_NECKWARMER, 1,"Practically named itself.", 410, Paths.CLOTHING_NECKWARMER_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.SCARF, Item.Tag.DYEABLE, Item.Tag.CLOTHING));
            AddToDictionary(SASH = new ClothingItem("Sash", Paths.ITEM_SASH, Paths.ITEM_SASH, 1,"Feeling sashy?", 420, Paths.CLOTHING_SASH_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.SCARF, Item.Tag.DYEABLE, Item.Tag.CLOTHING));
            AddToDictionary(TIE = new ClothingItem("Tie", Paths.ITEM_TIE, Paths.ITEM_TIE, 1,"Looking sharp!", 600, Paths.CLOTHING_TIE_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.SCARF, Item.Tag.DYEABLE, Item.Tag.CLOTHING));
            AddToDictionary(NECKLACE = new ClothingItem("Necklace", Paths.ITEM_NECKLACE, Paths.ITEM_NECKLACE, 1,"Made out of real pearls! This one is very valuable.", 4400, Paths.CLOTHING_NECKLACE_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.SCARF, Item.Tag.DYEABLE, Item.Tag.CLOTHING));

            AddToDictionary(ALL_SEASON_JACKET = new ClothingItem("All-Season Jacket", Paths.ITEM_ALL_SEASON_JACKET, Paths.ITEM_ALL_SEASON_JACKET, 1,"It's water AND windproof.", 1400, Paths.CLOTHING_ALL_SEASON_JACKET_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.OUTERWEAR, Item.Tag.DYEABLE, Item.Tag.CLOTHING));
            AddToDictionary(APRON = new ClothingItem("Apron", Paths.ITEM_APRON, Paths.ITEM_APRON, 1,"Flame retardant, but still suitable for the kitchen too.", 3200, Paths.CLOTHING_APRON_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.OUTERWEAR, Item.Tag.DYEABLE, Item.Tag.CLOTHING));
            AddToDictionary(BATHROBE = new ClothingItem("Bathrobe", Paths.ITEM_BATHROBE, Paths.ITEM_BATHROBE, 1,"Like wearing a towel, but socially acceptable.", 4100, Paths.CLOTHING_BATHROBE_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.OUTERWEAR, Item.Tag.DYEABLE, Item.Tag.CLOTHING));
            AddToDictionary(NOMAD_VEST = new ClothingItem("Nomad Vest", Paths.ITEM_NOMAD_VEST, Paths.ITEM_NOMAD_VEST, 1,"Lightweight and made to move.", 3800, Paths.CLOTHING_NOMAD_VEST_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.OUTERWEAR, Item.Tag.DYEABLE, Item.Tag.CLOTHING));
            AddToDictionary(OVERCOAT = new ClothingItem("Overcoat", Paths.ITEM_OVERCOAT, Paths.ITEM_OVERCOAT, 1,"Smooth and suave.", 1900, Paths.CLOTHING_OVERCOAT_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.OUTERWEAR, Item.Tag.DYEABLE, Item.Tag.CLOTHING));
            AddToDictionary(PUNK_JACKET = new ClothingItem("Punk Jacket", Paths.ITEM_PUNK_JACKET, Paths.ITEM_PUNK_JACKET, 1, "Popular amongst delinquents.", 1100, Paths.CLOTHING_PUNK_JACKET_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.OUTERWEAR, Item.Tag.DYEABLE, Item.Tag.CLOTHING));
            AddToDictionary(RAINCOAT = new ClothingItem("Raincoat", Paths.ITEM_RAINCOAT, Paths.ITEM_RAINCOAT, 1,"The beeswax repels rain.", 1750, Paths.CLOTHING_RAINCOAT_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.OUTERWEAR, Item.Tag.DYEABLE, Item.Tag.CLOTHING));
            AddToDictionary(SPORTBALL_UNIFORM = new ClothingItem("Sportball Uniform", Paths.ITEM_SPORTBALL_UNIFORM, Paths.ITEM_SPORTBALL_UNIFORM, 1, "Batter up!/nPower play!/nPenalty kick!", 4600, Paths.CLOTHING_SPORTBALL_UNIFORM_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.OUTERWEAR, Item.Tag.DYEABLE, Item.Tag.CLOTHING));
            AddToDictionary(WEDDING_DRESS = new ClothingItem("Wedding Dress", Paths.ITEM_WEDDING_DRESS, Paths.ITEM_WEDDING_DRESS, 1,"For a special day.", 5200, Paths.CLOTHING_WEDDING_DRESS_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.OUTERWEAR, Item.Tag.DYEABLE, Item.Tag.CLOTHING));

            AddToDictionary(JEANS = new ClothingItem("Jeans", Paths.ITEM_JEANS, Paths.ITEM_JEANS, 1,"Pants made of thick denim. The working man's standby.", 750, Paths.CLOTHING_JEANS_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.PANTS, Item.Tag.DYEABLE, Item.Tag.CLOTHING));
            AddToDictionary(CHINO_SHORTS = new ClothingItem("Chino Shorts", Paths.ITEM_CHINO_SHORTS, Paths.ITEM_CHINO_SHORTS, 1,"Comfy and easy to wear!", 540, Paths.CLOTHING_CHINO_SHORTS_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.PANTS, Item.Tag.DYEABLE, Item.Tag.CLOTHING));
            AddToDictionary(JEAN_SHORTS = new ClothingItem("Jean Shorts", Paths.ITEM_JEAN_SHORTS, Paths.ITEM_JEAN_SHORTS, 1,"Jorts?", 450, Paths.CLOTHING_JEAN_SHORTS_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.PANTS, Item.Tag.DYEABLE, Item.Tag.CLOTHING));
            AddToDictionary(CHINOS = new ClothingItem("Chinos", Paths.ITEM_CHINOS, Paths.ITEM_CHINOS, 1,"AKA Khakis. But Khaki is a color. Chino is the technical name for this type of pant.", 750, Paths.CLOTHING_CHINOS_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.PANTS, Item.Tag.DYEABLE, Item.Tag.CLOTHING));
            AddToDictionary(LONG_SKIRT = new ClothingItem("Long Skirt", Paths.ITEM_LONG_SKIRT, Paths.ITEM_LONG_SKIRT, 1,"Surprisingly mobile.", 800, Paths.CLOTHING_LONG_SKIRT_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.PANTS, Item.Tag.DYEABLE, Item.Tag.CLOTHING, Item.Tag.DRAW_OVER_SHOES));
            AddToDictionary(PUFF_SKIRT = new ClothingItem("Puff Skirt", Paths.ITEM_PUFF_SKIRT, Paths.ITEM_PUFF_SKIRT, 1,"Jiggly!", 1850, Paths.CLOTHING_PUFF_SKIRT_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.PANTS, Item.Tag.DYEABLE, Item.Tag.CLOTHING, Item.Tag.DRAW_OVER_SHOES));
            AddToDictionary(SHORT_SKIRT = new ClothingItem("Short Skirt", Paths.ITEM_SHORT_SKIRT, Paths.ITEM_SHORT_SKIRT, 1,"Just the right length!", 470, Paths.CLOTHING_SHORT_SKIRT_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.PANTS, Item.Tag.DYEABLE, Item.Tag.CLOTHING, Item.Tag.DRAW_OVER_SHOES));
            AddToDictionary(SUPER_SHORTS = new ClothingItem("Super Shorts", Paths.ITEM_SUPER_SHORTS, Paths.ITEM_SUPER_SHORTS, 1,"These super shorts are super short.", 710, Paths.CLOTHING_SUPER_SHORTS_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.PANTS, Item.Tag.DYEABLE, Item.Tag.CLOTHING));
            AddToDictionary(TIGHTIES = new ClothingItem("Tighties", Paths.ITEM_TIGHTIES, Paths.ITEM_TIGHTIES, 1,"And white-ies!", 820, Paths.CLOTHING_TIGHTIES_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.PANTS, Item.Tag.DYEABLE, Item.Tag.CLOTHING));
            AddToDictionary(TORN_JEANS = new ClothingItem("Torn Jeans", Paths.ITEM_TORN_JEANS, Paths.ITEM_TORN_JEANS, 1,"Just a touch of rebellion...", 950, Paths.CLOTHING_TORN_JEANS_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.PANTS, Item.Tag.DYEABLE, Item.Tag.CLOTHING));

            AddToDictionary(SAILCLOTH = new ClothingItem("Sailcloth", Paths.ITEM_SAILCLOTH, Paths.ITEM_SAILCLOTH, 1,"A traditional woven cloth of the mountains. Somehow, it lets you glide. Physicists are baffled by this enigma.", 1300, Paths.CLOTHING_SAILCLOTH_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.SAILCLOTH, Item.Tag.DYEABLE, Item.Tag.CLOTHING));

            AddToDictionary(SHORT_SLEEVE_TEE = new ClothingItem("Short-sleeve Tee", Paths.ITEM_SHORT_SLEEVE_TEE, Paths.ITEM_SHORT_SLEEVE_TEE, 1,"The classic!", 320, Paths.CLOTHING_SHORT_SLEEVE_TEE_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.SHIRT, Item.Tag.DYEABLE, Item.Tag.CLOTHING));
            AddToDictionary(ISLANDER_TATTOO = new ClothingItem("Islander Tattoo", Paths.ITEM_ISLANDER_TATTOO, Paths.ITEM_BUTTON_DOWN, 1,"The glyph seems to hold some strange power...", 1200, Paths.CLOTHING_ISLANDER_TATTOO_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.SHIRT, Item.Tag.DYEABLE, Item.Tag.CLOTHING));
            AddToDictionary(LONG_SLEEVE_TEE = new ClothingItem("Long-sleeve Tee", Paths.ITEM_LONG_SLEEVE_TEE, Paths.ITEM_LONG_SLEEVE_TEE, 1,"A bit more heavyweight than a typical tee, too.", 600, Paths.CLOTHING_LONG_SLEEVE_TEE_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.SHIRT, Item.Tag.DYEABLE, Item.Tag.CLOTHING));
            AddToDictionary(STRIPED_SHIRT = new ClothingItem("Striped Shirt", Paths.ITEM_STRIPED_SHIRT, Paths.ITEM_STRIPED_SHIRT, 1,"Navel in nature.", 940, Paths.CLOTHING_STRIPED_SHIRT_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.SHIRT, Item.Tag.DYEABLE, Item.Tag.CLOTHING));
            AddToDictionary(TANKER = new ClothingItem("Tanker", Paths.ITEM_TANKER, Paths.ITEM_TANKER, 1,"Run & gun.", 520, Paths.CLOTHING_TANKER_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.SHIRT, Item.Tag.DYEABLE, Item.Tag.CLOTHING));

            //combination shirt + outerwear
            AddToDictionary(SUIT_JACKET = new ClothingItem("Suit Jacket", Paths.ITEM_SUIT_JACKET, Paths.ITEM_SUIT_JACKET, 1, "Fit for any ballroom.", 1900, Paths.CLOTHING_SUIT_JACKET_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.OUTERWEAR, Item.Tag.DYEABLE, Item.Tag.CLOTHING, Item.Tag.SHIRT));
            AddToDictionary(ONESIE = new ClothingItem("Onesie", Paths.ITEM_ONESIE, Paths.ITEM_ONESIE, 1, "But what would a twosie look like?", 2850, Paths.CLOTHING_ONESIE_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.OUTERWEAR, Item.Tag.DYEABLE, Item.Tag.CLOTHING, Item.Tag.SHIRT));
            AddToDictionary(OVERALLS = new ClothingItem("Overalls", Paths.ITEM_OVERALLS, Paths.ITEM_OVERALLS, 1, "A farming classic. Made for work!", 2200, Paths.CLOTHING_OVERALLS_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.OUTERWEAR, Item.Tag.DYEABLE, Item.Tag.CLOTHING, Item.Tag.SHIRT));
            AddToDictionary(BUTTON_DOWN = new ClothingItem("Button-Down", Paths.ITEM_BUTTON_DOWN, Paths.ITEM_BUTTON_DOWN, 1, "The term \"button-down\" refers to the collar. This type of shirt is actually called a button-up.", 2800, Paths.CLOTHING_BUTTON_DOWN_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.SHIRT, Item.Tag.DYEABLE, Item.Tag.CLOTHING, Item.Tag.OUTERWEAR));
            AddToDictionary(HOODED_SWEATSHIRT = new ClothingItem("Hooded Sweatshirt", Paths.ITEM_HOODED_SWEATSHIRT, Paths.ITEM_HOODED_SWEATSHIRT, 1, "Perfect for lounging about on a lazy day.", 1300, Paths.CLOTHING_HOODED_SWEATSHIRT_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.OUTERWEAR, Item.Tag.DYEABLE, Item.Tag.CLOTHING, Item.Tag.SHIRT));
            AddToDictionary(LINEN_BUTTON = new ClothingItem("Linen Button", Paths.ITEM_LINEN_BUTTON, Paths.ITEM_LINEN_BUTTON, 1, "Perfect for a day on the beach.", 2750, Paths.CLOTHING_LINEN_BUTTON_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.SHIRT, Item.Tag.DYEABLE, Item.Tag.CLOTHING, Item.Tag.OUTERWEAR));
            AddToDictionary(PLAID_BUTTON = new ClothingItem("Plaid Button", Paths.ITEM_PLAID_BUTTON, Paths.ITEM_PLAID_BUTTON, 1, "Lumberjack made urban.", 3000, Paths.CLOTHING_PLAID_BUTTON_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.SHIRT, Item.Tag.DYEABLE, Item.Tag.CLOTHING, Item.Tag.OUTERWEAR));
            AddToDictionary(SWEATER = new ClothingItem("Sweater", Paths.ITEM_SWEATER, Paths.ITEM_SWEATER, 1, "Woven with warmth.", 1100, Paths.CLOTHING_SWEATER_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.SHIRT, Item.Tag.DYEABLE, Item.Tag.CLOTHING, Item.Tag.OUTERWEAR));
            AddToDictionary(TURTLENECK = new ClothingItem("Turtleneck", Paths.ITEM_TURTLENECK, Paths.ITEM_TURTLENECK, 1, "Named after tortoises.", 900,Paths.CLOTHING_TURTLENECK_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.SHIRT, Item.Tag.DYEABLE, Item.Tag.CLOTHING, Item.Tag.OUTERWEAR));

            AddToDictionary(SNEAKERS = new ClothingItem("Sneakers", Paths.ITEM_SNEAKERS, Paths.ITEM_SNEAKERS, 1,"Made for running!", 500, Paths.CLOTHING_SNEAKERS_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.SHOES, Item.Tag.DYEABLE, Item.Tag.CLOTHING));
            AddToDictionary(FLASH_HEELS = new ClothingItem("Flash Heels", Paths.ITEM_FLASH_HEELS, Paths.ITEM_FLASH_HEELS, 1,"Hit the climax!", 1350, Paths.CLOTHING_FLASH_HEELS_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.SHOES, Item.Tag.DYEABLE, Item.Tag.CLOTHING));
            AddToDictionary(WING_SANDLES = new ClothingItem("Wing Sandles", Paths.ITEM_WING_SANDLES, Paths.ITEM_WING_SANDLES, 1,"Footwear of choice for a long-forgotten civilization.", 1800, Paths.CLOTHING_WING_SANDLES_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.SHOES, Item.Tag.DYEABLE, Item.Tag.CLOTHING));
            AddToDictionary(HIGH_TOPS = new ClothingItem("High Tops", Paths.ITEM_HIGH_TOPS, Paths.ITEM_HIGH_TOPS, 1,"Some pumped up kicks.", 800, Paths.CLOTHING_HIGH_TOPS_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.SHOES, Item.Tag.DYEABLE, Item.Tag.CLOTHING));
            AddToDictionary(TALL_BOOTS = new ClothingItem("Tall Boots", Paths.ITEM_TALL_BOOTS, Paths.ITEM_TALL_BOOTS, 1,"Made for mountaineers and country roads.", 550, Paths.CLOTHING_TALL_BOOTS_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.SHOES, Item.Tag.DYEABLE, Item.Tag.CLOTHING));

            AddToDictionary(SHORT_SOCKS = new ClothingItem("Short Socks", Paths.ITEM_SHORT_SOCKS, Paths.ITEM_SHORT_SOCKS, 1,"A basic pair of socks. Like, really basic.", 320, Paths.CLOTHING_SHORT_SOCKS_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.SOCKS, Item.Tag.DYEABLE, Item.Tag.CLOTHING));
            AddToDictionary(LONG_SOCKS = new ClothingItem("Long Socks", Paths.ITEM_LONG_SOCKS, Paths.ITEM_LONG_SOCKS, 1,"Could also be called leggings.", 650, Paths.CLOTHING_LONG_SOCKS_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.SOCKS, Item.Tag.DYEABLE, Item.Tag.CLOTHING));
            AddToDictionary(STRIPED_SOCKS = new ClothingItem("Striped Socks", Paths.ITEM_STRIPED_SOCKS, Paths.ITEM_STRIPED_SOCKS, 1,"The stripes add a little more pizazz.", 380, Paths.CLOTHING_STRIPED_SOCKS_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.SOCKS, Item.Tag.DYEABLE, Item.Tag.CLOTHING));
            AddToDictionary(FESTIVE_SOCKS = new ClothingItem("Festive Socks", Paths.ITEM_FESTIVE_SOCKS, Paths.ITEM_FESTIVE_SOCKS, 1,"Made for elves. Made by elves.", 520, Paths.CLOTHING_FESTIVE_SOCKS_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.SOCKS, Item.Tag.DYEABLE, Item.Tag.CLOTHING));
            AddToDictionary(MISMATTCHED = new ClothingItem("Mismattched", Paths.ITEM_MISMATTCHED, Paths.ITEM_MISMATTCHED, 1, "A laundry nightmare made material.", 1560, Paths.CLOTHING_MISMATTCHED_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.SOCKS, Item.Tag.DYEABLE, Item.Tag.CLOTHING));

            AddToDictionary(HAIR_AFRO_ALFONSO = new ClothingItem("Afro Alfonso", Paths.ITEM_NONE, Paths.ITEM_NONE, 1,"mh1desc", 0, Paths.HAIR_AFRO_ALFONSO_SPRITESHEET, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.HAIR, Item.Tag.HIDE_WHEN_HAT));
            AddToDictionary(HAIR_BAREBONES_BRIAN = new ClothingItem("Barebones Brian", Paths.ITEM_NONE, Paths.ITEM_NONE, 1,"mh2desc", 0, Paths.HAIR_BAREBONES_BRIAN_SPRITESHEET, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.HAIR));
            AddToDictionary(HAIR_BENNY_BOWLCUT = new ClothingItem("Benny Bowlcut", Paths.ITEM_NONE, Paths.ITEM_NONE, 1,"mh3desc", 0, Paths.HAIR_BENNY_BOWLCUT_SPRITESHEET, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.HAIR));
            AddToDictionary(HAIR_CARLOS_COOL = new ClothingItem("Carlos Cool", Paths.ITEM_NONE, Paths.ITEM_NONE, 1,"mh4desc", 0, Paths.HAIR_CARLOS_COOL_SPRITESHEET, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.HAIR, Item.Tag.HIDE_WHEN_HAT));
            AddToDictionary(HAIR_CLEAN_CONOR = new ClothingItem("Clean Conor", Paths.ITEM_NONE, Paths.ITEM_NONE, 1,"mh5desc", 0, Paths.HAIR_CLEAN_CONOR_SPRITESHEET, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.HAIR, Item.Tag.HIDE_WHEN_HAT));
            AddToDictionary(HAIR_COMBED_CHRISTOPH = new ClothingItem("Combed Chrisotph", Paths.ITEM_NONE, Paths.ITEM_NONE, 1,"mh6desc", 0, Paths.HAIR_COMBED_CHRISTOPH_SPRITESHEET, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.HAIR));
            AddToDictionary(HAIR_COWLICK_COLTON = new ClothingItem("Cowlick Colton", Paths.ITEM_NONE, Paths.ITEM_NONE, 1,"mh7desc", 0, Paths.HAIR_COWLICK_COLTON_SPRITESHEET, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.HAIR));
            AddToDictionary(HAIR_DIRTY_JACK = new ClothingItem("Dirty Jack", Paths.ITEM_NONE, Paths.ITEM_NONE, 1,"mh8desc", 0, Paths.HAIR_DIRTY_JACK_SPRITESHEET, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.HAIR));
            AddToDictionary(HAIR_FREDDIE_FRINGE = new ClothingItem("Freddie Fringe", Paths.ITEM_NONE, Paths.ITEM_NONE, 1,"mh9desc", 0, Paths.HAIR_FREDDIE_FRINGE_SPRITESHEET, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.HAIR));
            AddToDictionary(HAIR_GABRIEL_PART = new ClothingItem("Gabriel Part", Paths.ITEM_NONE, Paths.ITEM_NONE, 1,"mh10desc", 0, Paths.HAIR_GABRIEL_PART_SPRITESHEET, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.HAIR));
            AddToDictionary(HAIR_LAZY_XAVIER = new ClothingItem("Lazy Xavier", Paths.ITEM_NONE, Paths.ITEM_NONE, 1,"mh11desc", 0, Paths.HAIR_LAZY_XAVIER_SPRITESHEET, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.HAIR));
            AddToDictionary(HAIR_LUCKY_LUKE = new ClothingItem("Lucky Luke", Paths.ITEM_NONE, Paths.ITEM_NONE, 1,"mh12desc", 0, Paths.HAIR_LUCKY_LUKE_SPRITESHEET, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.HAIR));
            AddToDictionary(HAIR_MAXWELL_MOHAWK = new ClothingItem("Maxwell Mohawk", Paths.ITEM_NONE, Paths.ITEM_NONE, 1,"mh13desc", 0, Paths.HAIR_MAXWELL_MOHAWK_SPRITESHEET, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.HAIR, Item.Tag.HIDE_WHEN_HAT));
            AddToDictionary(HAIR_MR_BALD = new ClothingItem("Mr Bald", Paths.ITEM_NONE, Paths.ITEM_NONE, 1,"mh14desc", 0, Paths.HAIR_MR_BALD_SPRITESHEET, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.HAIR));
            AddToDictionary(HAIR_OVERHANG_OWEN = new ClothingItem("Overhang Owen", Paths.ITEM_NONE, Paths.ITEM_NONE, 1,"mh15desc", 0, Paths.HAIR_OVERHANG_OWEN_SPRITESHEET, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.HAIR));
            AddToDictionary(HAIR_PONYTAIL_TONYTALE = new ClothingItem("Ponytail Tonytale", Paths.ITEM_NONE, Paths.ITEM_NONE, 1,"mh16desc", 0, Paths.HAIR_PONYTAIL_TONYTALE_SPRITESHEET, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.HAIR));
            AddToDictionary(HAIR_SKULLCAP_STEVENS = new ClothingItem("Skullcap Stevens", Paths.ITEM_NONE, Paths.ITEM_NONE, 1,"mh17desc", 0, Paths.HAIR_SKULLCAP_STEVENS_SPRITESHEET, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.HAIR));

            AddToDictionary(HAIR_ALIENATED_ALICE = new ClothingItem("Alienated Alice", Paths.ITEM_NONE, Paths.ITEM_NONE, 1,"fh1desc", 0, Paths.HAIR_ALIENATED_ALICE_SPRITESHEET, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.HAIR, Item.Tag.HIDE_WHEN_HAT));
            AddToDictionary(HAIR_BERTHA_BUN = new ClothingItem("Bertha Bun", Paths.ITEM_NONE, Paths.ITEM_NONE, 1,"fh2desc", 0, Paths.HAIR_BERTHA_BUN_SPRITESHEET, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.HAIR));
            AddToDictionary(HAIR_CLEANCUT_CHARLOTTE = new ClothingItem("Cleancut Charlotte", Paths.ITEM_NONE, Paths.ITEM_NONE, 1,"fh3desc", 0, Paths.HAIR_CLEANCUT_CHARLOTTE_SPRITESHEET, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.HAIR));
            AddToDictionary(HAIR_EARNEST_EMMA = new ClothingItem("Earnest Emma", Paths.ITEM_NONE, Paths.ITEM_NONE, 1,"fh4desc", 0, Paths.HAIR_EARNEST_EMMA_SPRITESHEET, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.HAIR));
            AddToDictionary(HAIR_FLASHY_FRIZZLE = new ClothingItem("Flashy Frizzle", Paths.ITEM_NONE, Paths.ITEM_NONE, 1,"fh5desc", 0, Paths.HAIR_FLASHY_FRIZZLE_SPRITESHEET, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.HAIR, Item.Tag.HIDE_WHEN_HAT));
            AddToDictionary(HAIR_FLUFFY_FELICIA = new ClothingItem("Fluffy Felicia", Paths.ITEM_NONE, Paths.ITEM_NONE, 1,"fh6desc", 0, Paths.HAIR_FLUFFY_FELICIA_SPRITESHEET, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.HAIR));
            AddToDictionary(HAIR_GORGEOUS_GEORGEANN = new ClothingItem("Gorgeous Georgeann", Paths.ITEM_NONE, Paths.ITEM_NONE, 1,"fh7desc", 0, Paths.HAIR_GORGEOUS_GEORGEANN_SPRITESHEET, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.HAIR));
            AddToDictionary(HAIR_HANGOVER_HANNA = new ClothingItem("Hangover Hanna", Paths.ITEM_NONE, Paths.ITEM_NONE, 1,"fh9desc", 0, Paths.HAIR_HANGOVER_HANNA_SPRITESHEET, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.HAIR));
            AddToDictionary(HAIR_INNOCENT_ILIA = new ClothingItem("Innocent Ilia", Paths.ITEM_NONE, Paths.ITEM_NONE, 1,"fh10desc", 0, Paths.HAIR_INNOCENT_ILIA_SPRITESHEET, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.HAIR));
            AddToDictionary(HAIR_LUXURY_LARA = new ClothingItem("Luxury Lara", Paths.ITEM_NONE, Paths.ITEM_NONE, 1,"fh11desc", 0, Paths.HAIR_LUXURY_LARA_SPRITESHEET, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.HAIR));
            AddToDictionary(HAIR_MOUNTAIN_CLIMBER_MADELINE = new ClothingItem("Mountain Climber Madeline", Paths.ITEM_NONE, Paths.ITEM_NONE, 1,"fh12desc", 0, Paths.HAIR_MOUNTAIN_CLIMBER_MADELINE_SPRITESHEET, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.HAIR));
            AddToDictionary(HAIR_PADMA_PERFECTION = new ClothingItem("Padma Perfection", Paths.ITEM_NONE, Paths.ITEM_NONE, 1,"fh13desc", 0, Paths.HAIR_PADMA_PERFECTION_SPRITESHEET, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.HAIR));
            AddToDictionary(HAIR_PERSEPHONE_PUNK = new ClothingItem("Persephone Punk", Paths.ITEM_NONE, Paths.ITEM_NONE, 1,"fh14desc", 0, Paths.HAIR_PERSEPHONE_PUNK_SPRITESHEET, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.HAIR));
            AddToDictionary(HAIR_SOPHIA_SWING = new ClothingItem("Sophia Swing", Paths.ITEM_NONE, Paths.ITEM_NONE, 1,"fh15desc", 0, Paths.HAIR_SOPHIA_SWING_SPRITESHEET, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.HAIR));
            AddToDictionary(HAIR_STRICT_SUSIE = new ClothingItem("Strict Susie", Paths.ITEM_NONE, Paths.ITEM_NONE, 1,"fh16desc", 0, Paths.HAIR_STRICT_SUSIE_SPRITESHEET, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.HAIR));
            AddToDictionary(HAIR_THE_ORIGINAL_OLIVIA = new ClothingItem("The Original Olivia", Paths.ITEM_NONE, Paths.ITEM_NONE, 1,"fh17desc", 0, Paths.HAIR_THE_ORIGINAL_OLIVIA_SPRITESHEET, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.HAIR));
            AddToDictionary(HAIR_ZAPPY_ZADIE = new ClothingItem("Zappy Zadie", Paths.ITEM_NONE, Paths.ITEM_NONE, 1,"fh18desc", 0, Paths.HAIR_ZAPPY_ZADIE_SPRITESHEET, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.HAIR));

            AddToDictionary(FACIALHAIR_BARON_MUSTACHE = new ClothingItem("Baron Mustache", Paths.ITEM_NONE, Paths.ITEM_NONE, 1, "faha1", 0, Paths.FACIALHAIR_BARON_MUSTACHE_SPRITESHEET, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.FACIAL_HAIR));
            AddToDictionary(FACIALHAIR_BEARD = new ClothingItem("Beard", Paths.ITEM_NONE, Paths.ITEM_NONE, 1, "faha2", 0, Paths.FACIALHAIR_BEARD_SPRITESHEET, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.FACIAL_HAIR));
            AddToDictionary(FACIALHAIR_CAVEMAN = new ClothingItem("Caveman", Paths.ITEM_NONE, Paths.ITEM_NONE, 1, "faha3", 0, Paths.FACIALHAIR_CAVEMAN_SPRITESHEET, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.FACIAL_HAIR));
            AddToDictionary(FACIALHAIR_DROOPY = new ClothingItem("Droopy", Paths.ITEM_NONE, Paths.ITEM_NONE, 1, "faha4", 0, Paths.FACIALHAIR_DROOPY_SPRITESHEET, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.FACIAL_HAIR));
            AddToDictionary(FACIALHAIR_FLUFF = new ClothingItem("Fluff", Paths.ITEM_NONE, Paths.ITEM_NONE, 1, "faha5", 0, Paths.FACIALHAIR_FLUFF_SPRITESHEET, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.FACIAL_HAIR));
            AddToDictionary(FACIALHAIR_FULLBEARD = new ClothingItem("Fullbeard", Paths.ITEM_NONE, Paths.ITEM_NONE, 1, "faha6", 0, Paths.FACIALHAIR_FULLBEARD_SPRITESHEET, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.FACIAL_HAIR));
            AddToDictionary(FACIALHAIR_GOATEE = new ClothingItem("Goatee", Paths.ITEM_NONE, Paths.ITEM_NONE, 1, "faha7", 0, Paths.FACIALHAIR_GOATEE_SPRITESHEET, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.FACIAL_HAIR));
            AddToDictionary(FACIALHAIR_GOATEEBACK = new ClothingItem("Goatee Back", Paths.ITEM_NONE, Paths.ITEM_NONE, 1, "faha8", 0, Paths.FACIALHAIR_GOATEEBACK_SPRITESHEET, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.FACIAL_HAIR));
            AddToDictionary(FACIALHAIR_MONK = new ClothingItem("Monk", Paths.ITEM_NONE, Paths.ITEM_NONE, 1, "faha9", 0, Paths.FACIALHAIR_MONK_SPRITESHEET, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.FACIAL_HAIR));
            AddToDictionary(FACIALHAIR_SHORTBEARD = new ClothingItem("Shortbeard", Paths.ITEM_NONE, Paths.ITEM_NONE, 1, "faha10", 0, Paths.FACIALHAIR_SHORTBEARD_SPRITESHEET, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.FACIAL_HAIR));
            AddToDictionary(FACIALHAIR_SIDEBURNS = new ClothingItem("Sideburns", Paths.ITEM_NONE, Paths.ITEM_NONE, 1, "faha11", 0, Paths.FACIALHAIR_SIDEBURNS_SPRITESHEET, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.FACIAL_HAIR));
            AddToDictionary(FACIALHAIR_SOULPATCH = new ClothingItem("Soulpatch", Paths.ITEM_NONE, Paths.ITEM_NONE, 1, "faha12", 0, Paths.FACIALHAIR_SOULPATCH_SPRITESHEET, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.FACIAL_HAIR));

            AddToDictionary(SKIN_PEACH = new ClothingItem("Skin Peach", Paths.ITEM_NONE, Paths.ITEM_NONE, 1,"skpedesc", 0, Paths.SKIN_PEACH_SPRITESHEET, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.SKIN));
            AddToDictionary(SKIN_ALIEN = new ClothingItem("Skin Alien", Paths.ITEM_NONE, Paths.ITEM_NONE, 1,"skpedesc", 0, Paths.SKIN_ALIEN_SPRITESHEET, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.SKIN));
            AddToDictionary(SKIN_CHOCOLATE = new ClothingItem("Skin Chocolate", Paths.ITEM_NONE, Paths.ITEM_NONE, 1,"skpedesc", 0, Paths.SKIN_CHOCOLATE_SPRITESHEET, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.SKIN));
            AddToDictionary(SKIN_DRIFTER = new ClothingItem("Skin Drifter", Paths.ITEM_NONE, Paths.ITEM_NONE, 1,"skpedesc", 0, Paths.SKIN_DRIFTER_SPRITESHEET, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.SKIN));
            AddToDictionary(SKIN_ECRU = new ClothingItem("Skin Ecru", Paths.ITEM_NONE, Paths.ITEM_NONE, 1,"skpedesc", 0, Paths.SKIN_ECRU_SPRITESHEET, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.SKIN));
            AddToDictionary(SKIN_EXEMPLAR = new ClothingItem("Skin Exemplar", Paths.ITEM_NONE, Paths.ITEM_NONE, 1,"skpedesc", 0, Paths.SKIN_EXEMPLAR_SPRITESHEET, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.SKIN));
            AddToDictionary(SKIN_MERIDIAN = new ClothingItem("Skin Meridian", Paths.ITEM_NONE, Paths.ITEM_NONE, 1,"skpedesc", 0, Paths.SKIN_MERIDIAN_SPRITESHEET, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.SKIN));
            AddToDictionary(SKIN_MIDNIGHT = new ClothingItem("Skin Midnight", Paths.ITEM_NONE, Paths.ITEM_NONE, 1,"skpedesc", 0, Paths.SKIN_MIDNIGHT_SPRITESHEET, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.SKIN));
            AddToDictionary(SKIN_OLIVE = new ClothingItem("Skin Olive", Paths.ITEM_NONE, Paths.ITEM_NONE, 1,"skpedesc", 0, Paths.SKIN_OLIVE_SPRITESHEET, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.SKIN));
            AddToDictionary(SKIN_PHANTOM = new ClothingItem("Skin Phantom", Paths.ITEM_NONE, Paths.ITEM_NONE, 1,"skpedesc", 0, Paths.SKIN_PHANTOM_SPRITESHEET, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.SKIN));
            AddToDictionary(SKIN_RUSSET = new ClothingItem("Skin Russet", Paths.ITEM_NONE, Paths.ITEM_NONE, 1,"skpedesc", 0, Paths.SKIN_RUSSET_SPRITESHEET, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.SKIN));
            AddToDictionary(SKIN_SNOW = new ClothingItem("Skin Snow", Paths.ITEM_NONE, Paths.ITEM_NONE, 1,"skpedesc", 0, Paths.SKIN_SNOW_SPRITESHEET, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.SKIN));
            AddToDictionary(SKIN_KID = new ClothingItem("Skin Kid", Paths.ITEM_NONE, Paths.ITEM_NONE, 1, "skpedesc", 0, Paths.SKIN_KID_SPRITESHEET, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.SKIN)); //skin used exclusively for Cade

            //special clothing used exclusviely for cade
            AddToDictionary(SPECIAL_CADE_SPRING = new ClothingItem("Special Cade Spring", Paths.ITEM_NONE, Paths.ITEM_NONE, 1, "skpedesc", 0, Paths.SPECIAL_CADE_SPRING_SPRITESHEET, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.SHIRT)); //spring used exclusively for Cade
            AddToDictionary(SPECIAL_CADE_SUMMER = new ClothingItem("Special Cade Summer", Paths.ITEM_NONE, Paths.ITEM_NONE, 1, "skpedesc", 0, Paths.SPECIAL_CADE_SUMMER_SPRITESHEET, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.SHIRT)); //summer used exclusively for Cade
            AddToDictionary(SPECIAL_CADE_AUTUMN = new ClothingItem("Special Cade Autumn", Paths.ITEM_NONE, Paths.ITEM_NONE, 1, "skpedesc", 0, Paths.SPECIAL_CADE_AUTUMN_SPRITESHEET, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.SHIRT)); //autumn used exclusively for Cade
            AddToDictionary(SPECIAL_CADE_WINTER = new ClothingItem("Special Cade Winter", Paths.ITEM_NONE, Paths.ITEM_NONE, 1, "skpedesc", 0, Paths.SPECIAL_CADE_WINTER_SPRITESHEET, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.SHIRT)); //winter used exclusively for Cade

            AddToDictionary(EYES_AMBER = new ClothingItem("Eyes Amber", Paths.ITEM_NONE, Paths.ITEM_NONE, 1,"eyedesc", 0, Paths.EYES_AMBER_SPRITESHEET, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.EYES));
            AddToDictionary(EYES_BLANK = new ClothingItem("Eyes Blank", Paths.ITEM_NONE, Paths.ITEM_NONE, 1,"eyedesc", 0, Paths.EYES_BLANK_SPRITESHEET, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.EYES));
            AddToDictionary(EYES_BLUSH = new ClothingItem("Eyes Blush", Paths.ITEM_NONE, Paths.ITEM_NONE, 1,"eyedesc", 0, Paths.EYES_BLUSH_SPRITESHEET, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.EYES));
            AddToDictionary(EYES_BROWN = new ClothingItem("Eyes Brown", Paths.ITEM_NONE, Paths.ITEM_NONE, 1,"eyedesc", 0, Paths.EYES_BROWN_SPRITESHEET, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.EYES));
            AddToDictionary(EYES_DOT = new ClothingItem("Eyes Dot", Paths.ITEM_NONE, Paths.ITEM_NONE, 1,"eyedesc", 0, Paths.EYES_DOT_SPRITESHEET, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.EYES));
            AddToDictionary(EYES_EMERALD = new ClothingItem("Eyes Emerald", Paths.ITEM_NONE, Paths.ITEM_NONE, 1,"eyedesc", 0, Paths.EYES_EMERALD_SPRITESHEET, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.EYES));
            AddToDictionary(EYES_MINT = new ClothingItem("Eyes Mint", Paths.ITEM_NONE, Paths.ITEM_NONE, 1,"eyedesc", 0, Paths.EYES_MINT_SPRITESHEET, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.EYES));
            AddToDictionary(EYES_OCEAN = new ClothingItem("Eyes Ocean", Paths.ITEM_NONE, Paths.ITEM_NONE, 1,"eyedesc", 0, Paths.EYES_OCEAN_SPRITESHEET, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.EYES));
            AddToDictionary(EYES_SILVER = new ClothingItem("Eyes Silver", Paths.ITEM_NONE, Paths.ITEM_NONE, 1,"eyedesc", 0, Paths.EYES_SILVER_SPRITESHEET, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.EYES));
            AddToDictionary(EYES_SOLAR = new ClothingItem("Eyes Solar", Paths.ITEM_NONE, Paths.ITEM_NONE, 1,"eyedesc", 0, Paths.EYES_SOLAR_SPRITESHEET, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.EYES));
            AddToDictionary(EYES_TEAK = new ClothingItem("Eyes Teak", Paths.ITEM_NONE, Paths.ITEM_NONE, 1,"eyedesc", 0, Paths.EYES_TEAK_SPRITESHEET, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.EYES));
            AddToDictionary(EYES_FROST = new ClothingItem("Eyes Frost", Paths.ITEM_NONE, Paths.ITEM_NONE, 1,"eyedesc", 0, Paths.EYES_FROST_SPRITESHEET, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.EYES));

            AddToDictionary(SCAFFOLDING_WOOD = new BuildingBlockItem("Wooden Scaffolding", Paths.ITEM_SCAFFOLDING_WOOD, Paths.ITEM_NONE, Paths.SPRITE_SCAFFOLDING_WOOD, Paths.ITEM_NONE, BlockType.SCAFFOLDING, DEFAULT_STACK_SIZE, "Scaffolding made of wood. I can place this on my farm to build structures.", 5, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            AddToDictionary(SCAFFOLDING_METAL = new BuildingBlockItem("Metal Scaffolding", Paths.ITEM_SCAFFOLDING_METAL, Paths.ITEM_NONE, Paths.SPRITE_SCAFFOLDING_METAL, Paths.ITEM_NONE, BlockType.SCAFFOLDING, DEFAULT_STACK_SIZE, "Chainlink made of iron. I can place this on my farm to build structures.", 25, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            AddToDictionary(SCAFFOLDING_GOLDEN = new BuildingBlockItem("Golden Scaffolding", Paths.ITEM_SCAFFOLDING_GOLDEN, Paths.ITEM_NONE, Paths.SPRITE_SCAFFOLDING_GOLDEN, Paths.ITEM_NONE, BlockType.SCAFFOLDING, DEFAULT_STACK_SIZE, "An ornate pattern made of gold. I can place this on my farm to build structures.", 60, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            AddToDictionary(SCAFFOLDING_MYTHRIL = new BuildingBlockItem("Mythril Scaffolding", Paths.ITEM_SCAFFOLDING_MYTHRIL, Paths.ITEM_NONE, Paths.SPRITE_SCAFFOLDING_MYTHRIL, Paths.ITEM_NONE, BlockType.SCAFFOLDING, DEFAULT_STACK_SIZE, "Bars made of mythril. I can place this on my farm to build structures.", 55, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            AddToDictionary(PLATFORM_WOOD = new BuildingBlockItem("Wooden Platform", Paths.ITEM_PLATFORM_WOOD, Paths.ITEM_NONE, Paths.SPRITE_PLATFORM_WOOD, Paths.ITEM_NONE, BlockType.PLATFORM, DEFAULT_STACK_SIZE, "Platform made of wood. I can place this on my farm to build structures. Platforms are solid on top.", 10, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            AddToDictionary(PLATFORM_STONE = new BuildingBlockItem("Stone Platform", Paths.ITEM_PLATFORM_STONE, Paths.ITEM_NONE, Paths.SPRITE_PLATFORM_STONE, Paths.ITEM_NONE, BlockType.PLATFORM, DEFAULT_STACK_SIZE, "Platform made of stone. I can place this on my farm to build structures. Platforms are solid on top.", 15, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            AddToDictionary(PLATFORM_METAL = new BuildingBlockItem("Metal Platform", Paths.ITEM_PLATFORM_METAL, Paths.ITEM_NONE, Paths.SPRITE_PLATFORM_METAL, Paths.ITEM_NONE, BlockType.PLATFORM, DEFAULT_STACK_SIZE, "Platform made of iron. I can place this on my farm to build structures. Platforms are solid on top.", 50, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            AddToDictionary(PLATFORM_GOLDEN = new BuildingBlockItem("Golden Platform", Paths.ITEM_PLATFORM_GOLDEN, Paths.ITEM_NONE, Paths.SPRITE_PLATFORM_GOLDEN, Paths.ITEM_NONE, BlockType.PLATFORM, DEFAULT_STACK_SIZE, "Platform made of gold. I can place this on my farm to build structures. Platforms are solid on top.", 120, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            AddToDictionary(PLATFORM_MYTHRIL = new BuildingBlockItem("Mythril Platform", Paths.ITEM_PLATFORM_MYTHRIL, Paths.ITEM_NONE, Paths.SPRITE_PLATFORM_MYTHRIL, Paths.ITEM_NONE, BlockType.PLATFORM, DEFAULT_STACK_SIZE, "Platform made of mythril. I can place on my farm this to build structures. Platforms are solid on top.", 105, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            AddToDictionary(PLATFORM_PLANK = new BuildingBlockItem("Plank Platform", Paths.ITEM_PLATFORM_PLANK, Paths.ITEM_NONE, Paths.SPRITE_PLATFORM_PLANK, Paths.ITEM_NONE, BlockType.PLATFORM, DEFAULT_STACK_SIZE, "Platform made of planks. I can place this on my farm to build structures. Platforms are solid on top.", 10, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            AddToDictionary(PLATFORM_WOOD_FARM = new BuildingBlockItem("Wooden Farming Platform", Paths.ITEM_PLATFORM_WOOD_FARM, Paths.ITEM_NONE, Paths.SPRITE_PLATFORM_WOOD_FARM, Paths.ITEM_NONE, BlockType.PLATFORM_FARM, DEFAULT_STACK_SIZE, "Platform made of wood. I can place this on my farm to build structures. The dirt on the top is tillable soil.", 15, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            AddToDictionary(PLATFORM_METAL_FARM = new BuildingBlockItem("Metal Farming Platform", Paths.ITEM_PLATFORM_METAL_FARM, Paths.ITEM_NONE, Paths.SPRITE_PLATFORM_METAL_FARM, Paths.ITEM_NONE, BlockType.PLATFORM_FARM, DEFAULT_STACK_SIZE, "Platform made of iron. I can place this on my farm to build structures. The dirt on the top is tillable soil.", 80, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            AddToDictionary(PLATFORM_STONE_FARM = new BuildingBlockItem("Stone Farming Platform", Paths.ITEM_PLATFORM_STONE_FARM, Paths.ITEM_NONE, Paths.SPRITE_PLATFORM_STONE_FARM, Paths.ITEM_NONE, BlockType.PLATFORM_FARM, DEFAULT_STACK_SIZE, "Platform made of stone. I can place this on my farm to build structures. The dirt on the top is tillable soil.", 20, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            AddToDictionary(PLATFORM_GOLDEN_FARM = new BuildingBlockItem("Golden Farming Platform", Paths.ITEM_PLATFORM_GOLDEN_FARM, Paths.ITEM_NONE, Paths.SPRITE_PLATFORM_GOLDEN_FARM, Paths.ITEM_NONE, BlockType.PLATFORM_FARM, DEFAULT_STACK_SIZE, "Platform made of gold. I can place this on my farm to build structures. The dirt on the top is tillable soil.", 150, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            AddToDictionary(PLATFORM_MYTHRIL_FARM = new BuildingBlockItem("Mythril Farming Platform", Paths.ITEM_PLATFORM_MYTHRIL_FARM, Paths.ITEM_NONE, Paths.SPRITE_PLATFORM_MYTHRIL_FARM, Paths.ITEM_NONE, BlockType.PLATFORM_FARM, DEFAULT_STACK_SIZE, "Platform made of mythril. I can place this on my farm to build structures. The dirt on the top is tillable soil.", 170, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            AddToDictionary(BLOCK_WOOD = new BuildingBlockItem("Wooden Block", Paths.ITEM_BLOCK_WOOD, Paths.ITEM_NONE, Paths.SPRITE_BLOCK_WOOD, Paths.ITEM_NONE, BlockType.BLOCK, DEFAULT_STACK_SIZE, "A square block made of wood. I can place this on my farm to build structures.", 15, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            AddToDictionary(BLOCK_METAL = new BuildingBlockItem("Metal Block", Paths.ITEM_BLOCK_METAL, Paths.ITEM_NONE, Paths.SPRITE_BLOCK_METAL, Paths.ITEM_NONE, BlockType.BLOCK, DEFAULT_STACK_SIZE, "A metal block made of iron. I can place this on my farm to build structures.", 70, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            AddToDictionary(BLOCK_STONE = new BuildingBlockItem("Stone Block", Paths.ITEM_BLOCK_STONE, Paths.ITEM_NONE, Paths.SPRITE_BLOCK_STONE, Paths.ITEM_NONE, BlockType.BLOCK, DEFAULT_STACK_SIZE, "A solid block made of stone. I can place this on my farm to build structures.", 25, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            AddToDictionary(BLOCK_GOLDEN = new BuildingBlockItem("Golden Block", Paths.ITEM_BLOCK_GOLDEN, Paths.ITEM_NONE, Paths.SPRITE_BLOCK_GOLDEN, Paths.ITEM_NONE, BlockType.BLOCK, DEFAULT_STACK_SIZE, "A shining block made of gold. I can place this on my farm to build structures.", 180, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            AddToDictionary(BLOCK_MYTHRIL = new BuildingBlockItem("Mythril Block", Paths.ITEM_BLOCK_MYTHRIL, Paths.ITEM_NONE, Paths.SPRITE_BLOCK_MYTHRIL, Paths.ITEM_NONE, BlockType.BLOCK, DEFAULT_STACK_SIZE, "A blue block made of mythril. I can place on my farm this to build structures.", 155, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            AddToDictionary(WALL_STONE = new BuildingBlockItem("Stone Wall", Paths.ITEM_WALL_STONE, Paths.ITEM_NONE, Paths.SPRITE_WALL_STONE, Paths.ITEM_NONE, BlockType.SCAFFOLDING, DEFAULT_STACK_SIZE, "Walls made of stone. I can place this on my farm to build structures.", 10, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            AddToDictionary(WALL_METAL = new BuildingBlockItem("Metal Wall", Paths.ITEM_WALL_METAL, Paths.ITEM_NONE, Paths.SPRITE_WALL_METAL, Paths.ITEM_NONE, BlockType.SCAFFOLDING, DEFAULT_STACK_SIZE, "Walls made of metal. I can place this on my farm to build structures.", 5, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            AddToDictionary(WALL_PLANK = new BuildingBlockItem("Plank Wall", Paths.ITEM_WALL_PLANK, Paths.ITEM_NONE, Paths.SPRITE_WALL_PLANK, Paths.ITEM_NONE, BlockType.SCAFFOLDING, DEFAULT_STACK_SIZE, "Walls made from planks. I can place this on my farm to build structures.", 15, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            AddToDictionary(BLOCK_PLANK = new BuildingBlockItem("Plank Block", Paths.ITEM_BLOCK_PLANK, Paths.ITEM_NONE, Paths.SPRITE_BLOCK_PLANK, Paths.ITEM_NONE, BlockType.BLOCK, DEFAULT_STACK_SIZE, "A crafty block made of planks. I can place this on my farm to build structures.", 25, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            AddToDictionary(BLOCK_BARK = new BuildingBlockItem("Bark Block", Paths.ITEM_BLOCK_BARK, Paths.ITEM_NONE, Paths.SPRITE_BLOCK_BARK, Paths.ITEM_NONE, BlockType.BLOCK, DEFAULT_STACK_SIZE, "A natural block made of bark. I can place this on my farm to build structures.", 15, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            ...
            foreach (Util.RecolorMap color in Util.DYE_COLORS)
            {
                ...
                AddToDictionary(MakeColoredVersion(ODD_WALLPAPER, color, Paths.ITEM_WALLPAPER_ODD_GREYSCALE, Paths.ITEM_WALLPAPER_ODD, Paths.SPRITE_WALLPAPER_ODD_GREYSCALE, Paths.SPRITE_WALLPAPER_ODD_GREYSCALE, Paths.SPRITE_WALLPAPER_ODD_GREYSCALE));
            ...
            {
                AddToDictionary(MakeColoredVersion(HAIR_AFRO_ALFONSO, hairColor, Paths.ITEM_NONE, Paths.HAIR_AFRO_ALFONSO_SPRITESHEET));
                AddToDictionary(MakeColoredVersion(HAIR_ALIENATED_ALICE, hairColor, Paths.ITEM_NONE, Paths.HAIR_ALIENATED_ALICE_SPRITESHEET));
                AddToDictionary(MakeColoredVersion(HAIR_BAREBONES_BRIAN, hairColor, Paths.ITEM_NONE, Paths.HAIR_BAREBONES_BRIAN_SPRITESHEET));
                AddToDictionary(MakeColoredVersion(HAIR_BENNY_BOWLCUT, hairColor, Paths.ITEM_NONE, Paths.HAIR_BENNY_BOWLCUT_SPRITESHEET));
                AddToDictionary(MakeColoredVersion(HAIR_BERTHA_BUN, hairColor, Paths.ITEM_NONE, Paths.HAIR_BERTHA_BUN_SPRITESHEET));
                AddToDictionary(MakeColoredVersion(HAIR_CARLOS_COOL, hairColor, Paths.ITEM_NONE, Paths.HAIR_CARLOS_COOL_SPRITESHEET));
                AddToDictionary(MakeColoredVersion(HAIR_CLEANCUT_CHARLOTTE, hairColor, Paths.ITEM_NONE, Paths.HAIR_CLEANCUT_CHARLOTTE_SPRITESHEET));
                AddToDictionary(MakeColoredVersion(HAIR_CLEAN_CONOR, hairColor, Paths.ITEM_NONE, Paths.HAIR_CLEAN_CONOR_SPRITESHEET));
                AddToDictionary(MakeColoredVersion(HAIR_COMBED_CHRISTOPH, hairColor, Paths.ITEM_NONE, Paths.HAIR_COMBED_CHRISTOPH_SPRITESHEET));
                AddToDictionary(MakeColoredVersion(HAIR_COWLICK_COLTON, hairColor, Paths.ITEM_NONE, Paths.HAIR_COWLICK_COLTON_SPRITESHEET));
                AddToDictionary(MakeColoredVersion(HAIR_DIRTY_JACK, hairColor, Paths.ITEM_NONE, Paths.HAIR_DIRTY_JACK_SPRITESHEET));
                AddToDictionary(MakeColoredVersion(HAIR_EARNEST_EMMA, hairColor, Paths.ITEM_NONE, Paths.HAIR_EARNEST_EMMA_SPRITESHEET));
                AddToDictionary(MakeColoredVersion(HAIR_FLASHY_FRIZZLE, hairColor, Paths.ITEM_NONE, Paths.HAIR_FLASHY_FRIZZLE_SPRITESHEET));
                AddToDictionary(MakeColoredVersion(HAIR_FLUFFY_FELICIA, hairColor, Paths.ITEM_NONE, Paths.HAIR_FLUFFY_FELICIA_SPRITESHEET));
                AddToDictionary(MakeColoredVersion(HAIR_FREDDIE_FRINGE, hairColor, Paths.ITEM_NONE, Paths.HAIR_FREDDIE_FRINGE_SPRITESHEET));
                AddToDictionary(MakeColoredVersion(HAIR_GABRIEL_PART, hairColor, Paths.ITEM_NONE, Paths.HAIR_GABRIEL_PART_SPRITESHEET));
                AddToDictionary(MakeColoredVersion(HAIR_GORGEOUS_GEORGEANN, hairColor, Paths.ITEM_NONE, Paths.HAIR_GORGEOUS_GEORGEANN_SPRITESHEET));
                AddToDictionary(MakeColoredVersion(HAIR_HANGOVER_HANNA, hairColor, Paths.ITEM_NONE, Paths.HAIR_HANGOVER_HANNA_SPRITESHEET));
                AddToDictionary(MakeColoredVersion(HAIR_INNOCENT_ILIA, hairColor, Paths.ITEM_NONE, Paths.HAIR_INNOCENT_ILIA_SPRITESHEET));
                AddToDictionary(MakeColoredVersion(HAIR_LAZY_XAVIER, hairColor, Paths.ITEM_NONE, Paths.HAIR_LAZY_XAVIER_SPRITESHEET));
                AddToDictionary(MakeColoredVersion(HAIR_LUCKY_LUKE, hairColor, Paths.ITEM_NONE, Paths.HAIR_LUCKY_LUKE_SPRITESHEET));
                AddToDictionary(MakeColoredVersion(HAIR_LUXURY_LARA, hairColor, Paths.ITEM_NONE, Paths.HAIR_LUXURY_LARA_SPRITESHEET));
                AddToDictionary(MakeColoredVersion(HAIR_MAXWELL_MOHAWK, hairColor, Paths.ITEM_NONE, Paths.HAIR_MAXWELL_MOHAWK_SPRITESHEET));
                AddToDictionary(MakeColoredVersion(HAIR_MOUNTAIN_CLIMBER_MADELINE, hairColor, Paths.ITEM_NONE, Paths.HAIR_MOUNTAIN_CLIMBER_MADELINE_SPRITESHEET));
                AddToDictionary(MakeColoredVersion(HAIR_MR_BALD, hairColor, Paths.ITEM_NONE, Paths.HAIR_MR_BALD_SPRITESHEET));
                AddToDictionary(MakeColoredVersion(HAIR_OVERHANG_OWEN, hairColor, Paths.ITEM_NONE, Paths.HAIR_OVERHANG_OWEN_SPRITESHEET));
                AddToDictionary(MakeColoredVersion(HAIR_PADMA_PERFECTION, hairColor, Paths.ITEM_NONE, Paths.HAIR_PADMA_PERFECTION_SPRITESHEET));
                AddToDictionary(MakeColoredVersion(HAIR_PERSEPHONE_PUNK, hairColor, Paths.ITEM_NONE, Paths.HAIR_PERSEPHONE_PUNK_SPRITESHEET));
                AddToDictionary(MakeColoredVersion(HAIR_PONYTAIL_TONYTALE, hairColor, Paths.ITEM_NONE, Paths.HAIR_PONYTAIL_TONYTALE_SPRITESHEET));
                AddToDictionary(MakeColoredVersion(HAIR_SKULLCAP_STEVENS, hairColor, Paths.ITEM_NONE, Paths.HAIR_SKULLCAP_STEVENS_SPRITESHEET));
                AddToDictionary(MakeColoredVersion(HAIR_SOPHIA_SWING, hairColor, Paths.ITEM_NONE, Paths.HAIR_SOPHIA_SWING_SPRITESHEET));
                AddToDictionary(MakeColoredVersion(HAIR_STRICT_SUSIE, hairColor, Paths.ITEM_NONE, Paths.HAIR_STRICT_SUSIE_SPRITESHEET));
                AddToDictionary(MakeColoredVersion(HAIR_THE_ORIGINAL_OLIVIA, hairColor, Paths.ITEM_NONE, Paths.HAIR_THE_ORIGINAL_OLIVIA_SPRITESHEET));
                AddToDictionary(MakeColoredVersion(HAIR_ZAPPY_ZADIE, hairColor, Paths.ITEM_NONE, Paths.HAIR_ZAPPY_ZADIE_SPRITESHEET));

                AddToDictionary(MakeColoredVersion(FACIALHAIR_BARON_MUSTACHE, hairColor, Paths.ITEM_NONE, Paths.FACIALHAIR_BARON_MUSTACHE_SPRITESHEET));
                AddToDictionary(MakeColoredVersion(FACIALHAIR_BEARD, hairColor, Paths.ITEM_NONE, Paths.FACIALHAIR_BEARD_SPRITESHEET));
                AddToDictionary(MakeColoredVersion(FACIALHAIR_CAVEMAN, hairColor, Paths.ITEM_NONE, Paths.FACIALHAIR_CAVEMAN_SPRITESHEET));
                AddToDictionary(MakeColoredVersion(FACIALHAIR_DROOPY, hairColor, Paths.ITEM_NONE, Paths.FACIALHAIR_DROOPY_SPRITESHEET));
                AddToDictionary(MakeColoredVersion(FACIALHAIR_FLUFF, hairColor, Paths.ITEM_NONE, Paths.FACIALHAIR_FLUFF_SPRITESHEET));
                AddToDictionary(MakeColoredVersion(FACIALHAIR_FULLBEARD, hairColor, Paths.ITEM_NONE, Paths.FACIALHAIR_FULLBEARD_SPRITESHEET));
                AddToDictionary(MakeColoredVersion(FACIALHAIR_GOATEE, hairColor, Paths.ITEM_NONE, Paths.FACIALHAIR_GOATEE_SPRITESHEET));
                AddToDictionary(MakeColoredVersion(FACIALHAIR_GOATEEBACK, hairColor, Paths.ITEM_NONE, Paths.FACIALHAIR_GOATEEBACK_SPRITESHEET));
                AddToDictionary(MakeColoredVersion(FACIALHAIR_MONK, hairColor, Paths.ITEM_NONE, Paths.FACIALHAIR_MONK_SPRITESHEET));
                AddToDictionary(MakeColoredVersion(FACIALHAIR_SHORTBEARD, hairColor, Paths.ITEM_NONE, Paths.FACIALHAIR_SHORTBEARD_SPRITESHEET));
                AddToDictionary(MakeColoredVersion(FACIALHAIR_SIDEBURNS, hairColor, Paths.ITEM_NONE, Paths.FACIALHAIR_SIDEBURNS_SPRITESHEET));
                AddToDictionary(MakeColoredVersion(FACIALHAIR_SOULPATCH, hairColor, Paths.ITEM_NONE, Paths.FACIALHAIR_SOULPATCH_SPRITESHEET));
            }
        }
