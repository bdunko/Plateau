...
namespace Plateau.Items
{
    public class ItemDict
    {
        ...
        public static void LoadContent(ContentManager content)
        {
            ...
            AddToDictionary(ONESIE = new ClothingItem("Onesie", Paths.ITEM_ONESIE, Paths.ITEM_ONESIE, 1,"But what would a twosie look like?", 2200, Paths.CLOTHING_ONESIE_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.OUTERWEAR, Item.Tag.DYEABLE, Item.Tag.CLOTHING));
            AddToDictionary(OVERALLS = new ClothingItem("Overalls", Paths.ITEM_OVERALLS, Paths.ITEM_OVERALLS, 1,"A farming classic. Made for work!", 2200, Paths.CLOTHING_OVERALLS_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.OUTERWEAR, Item.Tag.DYEABLE, Item.Tag.CLOTHING));
            ...
            AddToDictionary(SUIT_JACKET = new ClothingItem("Suit Jacket", Paths.ITEM_SUIT_JACKET, Paths.ITEM_SUIT_JACKET, 1,"Fit for any ballroom.", 1900, Paths.CLOTHING_SUIT_JACKET_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.OUTERWEAR, Item.Tag.DYEABLE, Item.Tag.CLOTHING));
            ...
            AddToDictionary(LINEN_BUTTON = new ClothingItem("Linen Button", Paths.ITEM_LINEN_BUTTON, Paths.ITEM_LINEN_BUTTON, 1,"Perfect for a day on the beach.", 2750, Paths.CLOTHING_LINEN_BUTTON_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.SHIRT, Item.Tag.DYEABLE, Item.Tag.CLOTHING));
            ...
            AddToDictionary(PLAID_BUTTON = new ClothingItem("Plaid Button", Paths.ITEM_PLAID_BUTTON, Paths.ITEM_PLAID_BUTTON, 1,"Lumberjack made urban.", 3000, Paths.CLOTHING_PLAID_BUTTON_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.SHIRT, Item.Tag.DYEABLE, Item.Tag.CLOTHING));
            ...
            AddToDictionary(SWEATER = new ClothingItem("Sweater", Paths.ITEM_SWEATER, Paths.ITEM_SWEATER, 1,"Woven with warmth.", 1100, Paths.CLOTHING_SWEATER_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.SHIRT, Item.Tag.DYEABLE, Item.Tag.CLOTHING));
            ...
            AddToDictionary(TURTLENECK = new ClothingItem("Turtleneck", Paths.ITEM_TURTLENECK, Paths.ITEM_TURTLENECK, 1, "Named after tortoises.", 900,Paths.CLOTHING_TURTLENECK_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.SHIRT, Item.Tag.DYEABLE, Item.Tag.CLOTHING));
            ...
            AddToDictionary(SPECIAL_CADE_SPRING = new ClothingItem("Special Cade Spring", Paths.ITEM_NONE, Paths.ITEM_NONE, 1, "skpedesc", 0, Paths.SPECIAL_CADE_SPRING_SPRITESHEET, Paths.CLOTHING_NONE_SPRITESHEET, null)); //spring used exclusively for Cade
            AddToDictionary(SPECIAL_CADE_SUMMER = new ClothingItem("Special Cade Summer", Paths.ITEM_NONE, Paths.ITEM_NONE, 1, "skpedesc", 0, Paths.SPECIAL_CADE_SUMMER_SPRITESHEET, Paths.CLOTHING_NONE_SPRITESHEET, null)); //summer used exclusively for Cade
            AddToDictionary(SPECIAL_CADE_AUTUMN = new ClothingItem("Special Cade Autumn", Paths.ITEM_NONE, Paths.ITEM_NONE, 1, "skpedesc", 0, Paths.SPECIAL_CADE_AUTUMN_SPRITESHEET, Paths.CLOTHING_NONE_SPRITESHEET, null)); //autumn used exclusively for Cade
            AddToDictionary(SPECIAL_CADE_WINTER = new ClothingItem("Special Cade Winter", Paths.ITEM_NONE, Paths.ITEM_NONE, 1, "skpedesc", 0, Paths.SPECIAL_CADE_WINTER_SPRITESHEET, Paths.CLOTHING_NONE_SPRITESHEET, null)); //winter used exclusively for Cade
