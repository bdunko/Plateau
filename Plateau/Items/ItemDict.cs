...
namespace Plateau.Items
{
    public class ItemDict
    {
        ...
        public static void LoadContent(ContentManager content)
        {
            ...
            AddToDictionary(TRIANGULATE_FLOOR = new PlaceableItem("Triangulate Floor", Paths.ITEM_FLOOR_TRIANGULATE, Paths.ITEM_FLOOR_TRIANGULATE, Paths.SPRITE_FLOOR_TRIANGULATE, Paths.SPRITE_FLOOR_TRIANGULATE, 1, 1, DEFAULT_STACK_SIZE, "A strange flooring pattern, perhaps used to signal to aliens?", 125, EntityType.FLOOR_DECOR, PlaceableItem.PlacementType.FLOOR, null, Item.Tag.DYEABLE, Item.Tag.PLACEABLE));
            ...
            AddToDictionary(WAVE_WALLPAPER = new WallpaperItem("Wave Wallpaper", Paths.ITEM_WALLPAPER_WAVE, Paths.ITEM_WALLPAPER_WAVE,
                ...
                1, 1, DEFAULT_STACK_SIZE, "Do the wave!", 165, EntityType.WALLPAPER, PlaceableItem.PlacementType.WALLPAPER, null, Item.Tag.DYEABLE, Item.Tag.PLACEABLE));
            ...
            AddToDictionary(SCAFFOLDING_MYTHRIL = new BuildingBlockItem("Mythril Scaffolding", Paths.ITEM_SCAFFOLDING_MYTHRIL, Paths.ITEM_NONE, Paths.SPRITE_SCAFFOLDING_MYTHRIL, Paths.ITEM_NONE, BlockType.SCAFFOLDING, DEFAULT_STACK_SIZE, "Bars made of mythril. I can place this on my farm to build structures.", 110, null, Item.Tag.DYEABLE, Item.Tag.PLACEABLE));
            AddToDictionary(PLATFORM_WOOD = new BuildingBlockItem("Wooden Platform", Paths.ITEM_PLATFORM_WOOD, Paths.ITEM_NONE, Paths.SPRITE_PLATFORM_WOOD, Paths.ITEM_NONE, BlockType.PLATFORM, DEFAULT_STACK_SIZE, "Platform made of wood. I can place this on my farm to build structures. Platforms are solid on top.", 15, null, Item.Tag.DYEABLE, Item.Tag.PLACEABLE));
            AddToDictionary(PLATFORM_STONE = new BuildingBlockItem("Stone Platform", Paths.ITEM_PLATFORM_STONE, Paths.ITEM_NONE, Paths.SPRITE_PLATFORM_STONE, Paths.ITEM_NONE, BlockType.PLATFORM, DEFAULT_STACK_SIZE, "Platform made of stone. I can place this on my farm to build structures. Platforms are solid on top.", 30, null, Item.Tag.DYEABLE, Item.Tag.PLACEABLE));
            AddToDictionary(PLATFORM_METAL = new BuildingBlockItem("Metal Platform", Paths.ITEM_PLATFORM_METAL, Paths.ITEM_NONE, Paths.SPRITE_PLATFORM_METAL, Paths.ITEM_NONE, BlockType.PLATFORM, DEFAULT_STACK_SIZE, "Platform made of iron. I can place this on my farm to build structures. Platforms are solid on top.", 100, null, Item.Tag.DYEABLE, Item.Tag.PLACEABLE));
            AddToDictionary(PLATFORM_GOLDEN = new BuildingBlockItem("Golden Platform", Paths.ITEM_PLATFORM_GOLDEN, Paths.ITEM_NONE, Paths.SPRITE_PLATFORM_GOLDEN, Paths.ITEM_NONE, BlockType.PLATFORM, DEFAULT_STACK_SIZE, "Platform made of gold. I can place this on my farm to build structures. Platforms are solid on top.", 240, null, Item.Tag.DYEABLE, Item.Tag.PLACEABLE));
            AddToDictionary(PLATFORM_MYTHRIL = new BuildingBlockItem("Mythril Platform", Paths.ITEM_PLATFORM_MYTHRIL, Paths.ITEM_NONE, Paths.SPRITE_PLATFORM_MYTHRIL, Paths.ITEM_NONE, BlockType.PLATFORM, DEFAULT_STACK_SIZE, "Platform made of mythril. I can place on my farm this to build structures. Platforms are solid on top.", 210, null, Item.Tag.DYEABLE, Item.Tag.PLACEABLE));
            AddToDictionary(PLATFORM_WOOD_FARM = new BuildingBlockItem("Wooden Farming Platform", Paths.ITEM_PLATFORM_WOOD_FARM, Paths.ITEM_NONE, Paths.SPRITE_PLATFORM_WOOD_FARM, Paths.ITEM_NONE, BlockType.PLATFORM_FARM, DEFAULT_STACK_SIZE, "Platform made of wood. I can place this on my farm to build structures. The dirt on the top is tillable soil.", 30, null, Item.Tag.DYEABLE, Item.Tag.PLACEABLE));
            AddToDictionary(PLATFORM_METAL_FARM = new BuildingBlockItem("Metal Farming Platform", Paths.ITEM_PLATFORM_METAL_FARM, Paths.ITEM_NONE, Paths.SPRITE_PLATFORM_METAL_FARM, Paths.ITEM_NONE, BlockType.PLATFORM_FARM, DEFAULT_STACK_SIZE, "Platform made of iron. I can place this on my farm to build structures. The dirt on the top is tillable soil.", 150, null, Item.Tag.DYEABLE, Item.Tag.PLACEABLE));
            AddToDictionary(PLATFORM_STONE_FARM = new BuildingBlockItem("Stone Farming Platform", Paths.ITEM_PLATFORM_STONE_FARM, Paths.ITEM_NONE, Paths.SPRITE_PLATFORM_STONE_FARM, Paths.ITEM_NONE, BlockType.PLATFORM_FARM, DEFAULT_STACK_SIZE, "Platform made of stone. I can place this on my farm to build structures. The dirt on the top is tillable soil.", 40, null, Item.Tag.DYEABLE, Item.Tag.PLACEABLE));
            AddToDictionary(PLATFORM_GOLDEN_FARM = new BuildingBlockItem("Golden Farming Platform", Paths.ITEM_PLATFORM_GOLDEN_FARM, Paths.ITEM_NONE, Paths.SPRITE_PLATFORM_GOLDEN_FARM, Paths.ITEM_NONE, BlockType.PLATFORM_FARM, DEFAULT_STACK_SIZE, "Platform made of gold. I can place this on my farm to build structures. The dirt on the top is tillable soil.", 280, null, Item.Tag.DYEABLE, Item.Tag.PLACEABLE));
            AddToDictionary(PLATFORM_MYTHRIL_FARM = new BuildingBlockItem("Mythril Farming Platform", Paths.ITEM_PLATFORM_MYTHRIL_FARM, Paths.ITEM_NONE, Paths.SPRITE_PLATFORM_MYTHRIL_FARM, Paths.ITEM_NONE, BlockType.PLATFORM_FARM, DEFAULT_STACK_SIZE, "Platform made of mythril. I can place this on my farm to build structures. The dirt on the top is tillable soil.", 250, null, Item.Tag.DYEABLE, Item.Tag.PLACEABLE));
            AddToDictionary(BLOCK_WOOD = new BuildingBlockItem("Wooden Block", Paths.ITEM_BLOCK_WOOD, Paths.ITEM_NONE, Paths.SPRITE_BLOCK_WOOD, Paths.ITEM_NONE, BlockType.BLOCK, DEFAULT_STACK_SIZE, "A square block made of wood. I can place this on my farm to build structures.", 25, null, Item.Tag.DYEABLE, Item.Tag.PLACEABLE));
            AddToDictionary(BLOCK_METAL = new BuildingBlockItem("Metal Block", Paths.ITEM_BLOCK_METAL, Paths.ITEM_NONE, Paths.SPRITE_BLOCK_METAL, Paths.ITEM_NONE, BlockType.BLOCK, DEFAULT_STACK_SIZE, "A metal block made of iron. I can place this on my farm to build structures.", 140, null, Item.Tag.DYEABLE, Item.Tag.PLACEABLE));
            AddToDictionary(BLOCK_STONE = new BuildingBlockItem("Stone Block", Paths.ITEM_BLOCK_STONE, Paths.ITEM_NONE, Paths.SPRITE_BLOCK_STONE, Paths.ITEM_NONE, BlockType.BLOCK, DEFAULT_STACK_SIZE, "A solid block made of stone. I can place this on my farm to build structures.", 45, null, Item.Tag.DYEABLE, Item.Tag.PLACEABLE));
            AddToDictionary(BLOCK_GOLDEN = new BuildingBlockItem("Golden Block", Paths.ITEM_BLOCK_GOLDEN, Paths.ITEM_NONE, Paths.SPRITE_BLOCK_GOLDEN, Paths.ITEM_NONE, BlockType.BLOCK, DEFAULT_STACK_SIZE, "A shining block made of gold. I can place this on my farm to build structures.", 360, null, Item.Tag.DYEABLE, Item.Tag.PLACEABLE));
            AddToDictionary(BLOCK_MYTHRIL = new BuildingBlockItem("Mythril Block", Paths.ITEM_BLOCK_MYTHRIL, Paths.ITEM_NONE, Paths.SPRITE_BLOCK_MYTHRIL, Paths.ITEM_NONE, BlockType.BLOCK, DEFAULT_STACK_SIZE, "A blue block made of mythril. I can place on my farm this to build structures.", 310, null, Item.Tag.DYEABLE, Item.Tag.PLACEABLE));
            AddToDictionary(WALL_STONE = new BuildingBlockItem("Stone Wall", Paths.ITEM_WALL_STONE, Paths.ITEM_NONE, Paths.SPRITE_WALL_STONE, Paths.ITEM_NONE, BlockType.SCAFFOLDING, DEFAULT_STACK_SIZE, "Walls made of stone. I can place this on my farm to build structures.", 15, null, Item.Tag.DYEABLE, Item.Tag.PLACEABLE));
            AddToDictionary(WALL_METAL = new BuildingBlockItem("Metal Wall", Paths.ITEM_WALL_METAL, Paths.ITEM_NONE, Paths.SPRITE_WALL_METAL, Paths.ITEM_NONE, BlockType.SCAFFOLDING, DEFAULT_STACK_SIZE, "Walls made of metal. I can place this on my farm to build structures.", 10, null, Item.Tag.DYEABLE, Item.Tag.PLACEABLE));
            AddToDictionary(WALL_PLANK = new BuildingBlockItem("Plank Wall", Paths.ITEM_WALL_PLANK, Paths.ITEM_NONE, Paths.SPRITE_WALL_PLANK, Paths.ITEM_NONE, BlockType.SCAFFOLDING, DEFAULT_STACK_SIZE, "Walls made from planks. I can place this on my farm to build structures.", 25, null, Item.Tag.DYEABLE, Item.Tag.PLACEABLE));
            AddToDictionary(PLATFORM_PLANK = new BuildingBlockItem("Plank Platform", Paths.ITEM_PLATFORM_PLANK, Paths.ITEM_NONE, Paths.SPRITE_PLATFORM_PLANK, Paths.ITEM_NONE, BlockType.PLATFORM, DEFAULT_STACK_SIZE, "Platform made of planks. I can place this on my farm to build structures. Platforms are solid on top.", 35, null, Item.Tag.DYEABLE, Item.Tag.PLACEABLE));
            AddToDictionary(BLOCK_PLANK = new BuildingBlockItem("Plank Block", Paths.ITEM_BLOCK_PLANK, Paths.ITEM_NONE, Paths.SPRITE_BLOCK_PLANK, Paths.ITEM_NONE, BlockType.BLOCK, DEFAULT_STACK_SIZE, "A crafty block made of planks. I can place this on my farm to build structures.", 50, null, Item.Tag.DYEABLE, Item.Tag.PLACEABLE));
            AddToDictionary(BLOCK_BARK = new BuildingBlockItem("Bark Block", Paths.ITEM_BLOCK_BARK, Paths.ITEM_NONE, Paths.SPRITE_BLOCK_BARK, Paths.ITEM_NONE, BlockType.BLOCK, DEFAULT_STACK_SIZE, "A natural block made of bark. I can place this on my farm to build structures.", 25, null, Item.Tag.DYEABLE, Item.Tag.PLACEABLE));
