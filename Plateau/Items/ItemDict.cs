...
namespace Plateau.Items
{
    public class ItemDict
    {
        ...
        public static void LoadContent(ContentManager content)
        {
            ...
            AddToDictionary(CONCRETE_FLOOR = new PlaceableItem("Concrete Floor", Paths.ITEM_FLOOR_CONCRETE, Paths.ITEM_FLOOR_CONCRETE, Paths.SPRITE_FLOOR_CONCRETE, Paths.SPRITE_FLOOR_CONCRETE, 1,1, DEFAULT_STACK_SIZE, "Basic floor made of concrete.", 65, EntityType.FLOOR_DECOR, PlaceableItem.PlacementType.FLOOR, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            AddToDictionary(STREET_FLOOR = new PlaceableItem("Street Floor", Paths.ITEM_FLOOR_STREET, Paths.ITEM_FLOOR_STREET, Paths.SPRITE_FLOOR_STREET, Paths.SPRITE_FLOOR_STREET, 1,1, DEFAULT_STACK_SIZE, "But where're the cars?", 60, EntityType.FLOOR_DECOR, PlaceableItem.PlacementType.FLOOR, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            AddToDictionary(CARPET_FLOOR = new PlaceableItem("Carpet Floor", Paths.ITEM_FLOOR_CARPET, Paths.ITEM_FLOOR_CARPET, Paths.SPRITE_FLOOR_CARPET, Paths.SPRITE_FLOOR_CARPET, 1,1, DEFAULT_STACK_SIZE, "Some carpet for your floors. Try dying it!", 60, EntityType.FLOOR_DECOR, PlaceableItem.PlacementType.FLOOR, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            AddToDictionary(BOARDWALK_FLOOR = new PlaceableItem("Boardwalk Floor", Paths.ITEM_FLOOR_BOARDWALK, Paths.ITEM_FLOOR_BOARDWALK, Paths.SPRITE_FLOOR_BOARDWALK, Paths.SPRITE_FLOOR_BOARDWALK, 1,1, DEFAULT_STACK_SIZE, "Not just for the beach.", 20, EntityType.FLOOR_DECOR, PlaceableItem.PlacementType.FLOOR, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            AddToDictionary(STEPPING_STONE_FLOOR = new PlaceableItem("Stepping Stone Floor", Paths.ITEM_FLOOR_STEPPING_STONE, Paths.ITEM_FLOOR_STEPPING_STONE, Paths.SPRITE_FLOOR_STEPPING_STONE, Paths.SPRITE_FLOOR_STEPPING_STONE, 1,1, DEFAULT_STACK_SIZE, "Commonly used to decorate gardens.", 25, EntityType.FLOOR_DECOR, PlaceableItem.PlacementType.FLOOR, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            AddToDictionary(WOODEN_FLOOR = new PlaceableItem("Wooden Floor", Paths.ITEM_FLOOR_WOODEN, Paths.ITEM_FLOOR_WOODEN, Paths.SPRITE_FLOOR_WOODEN, Paths.SPRITE_FLOOR_WOODEN, 1, 1, DEFAULT_STACK_SIZE, "Simple flooring made from wood.", 30, EntityType.FLOOR_DECOR, PlaceableItem.PlacementType.FLOOR, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            AddToDictionary(TATAMI_FLOOR = new PlaceableItem("Tatami Floor", Paths.ITEM_FLOOR_TATAMI, Paths.ITEM_FLOOR_TATAMI, Paths.SPRITE_FLOOR_TATAMI, Paths.SPRITE_FLOOR_TATAMI, 1, 1, DEFAULT_STACK_SIZE, "A flooring mat woven from bamboo.", 20, EntityType.FLOOR_DECOR, PlaceableItem.PlacementType.FLOOR, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            AddToDictionary(THIN_TATAMI_FLOOR = new PlaceableItem("Thin Tatami Floor", Paths.ITEM_FLOOR_THIN_TATAMI, Paths.ITEM_FLOOR_THIN_TATAMI, Paths.SPRITE_FLOOR_THIN_TATAMI, Paths.SPRITE_FLOOR_THIN_TATAMI, 1, 1, DEFAULT_STACK_SIZE, "Like normal tatami, but thin.", 15, EntityType.FLOOR_DECOR, PlaceableItem.PlacementType.FLOOR, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            AddToDictionary(MAT_FLOOR = new PlaceableItem("Mat Floor", Paths.ITEM_FLOOR_MAT, Paths.ITEM_FLOOR_MAT, Paths.SPRITE_FLOOR_MAT, Paths.SPRITE_FLOOR_MAT, 1, 1, DEFAULT_STACK_SIZE, "A thin cloth mat that can be used to decorate floors.", 75, EntityType.FLOOR_DECOR, PlaceableItem.PlacementType.FLOOR, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            ...
            AddToDictionary(TRIANGULATE_FLOOR = new PlaceableItem("Triangulate Floor", Paths.ITEM_FLOOR_TRIANGULATE, Paths.ITEM_FLOOR_TRIANGULATE, Paths.SPRITE_FLOOR_TRIANGULATE, Paths.SPRITE_FLOOR_TRIANGULATE, 1, 1, DEFAULT_STACK_SIZE, "A strange flooring pattern, perhaps used to signal to aliens?", 125, EntityType.FLOOR_DECOR, PlaceableItem.PlacementType.FLOOR, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            AddToDictionary(SQUARE_FLOOR = new PlaceableItem("Square Floor", Paths.ITEM_FLOOR_SQUARE, Paths.ITEM_FLOOR_SQUARE, Paths.SPRITE_FLOOR_SQUARE, Paths.SPRITE_FLOOR_SQUARE, 1, 1, DEFAULT_STACK_SIZE, "Fancy stepping stones roughly cut into square parts.", 50, EntityType.FLOOR_DECOR, PlaceableItem.PlacementType.FLOOR, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE,  Item.Tag.PLACEABLE));
            ...
            AddToDictionary(MYTHRIL_FENCE = new PlaceableItem("Mythril Fence", Paths.ITEM_MYTHRIL_FENCE, Paths.ITEM_MYTHRIL_FENCE, Paths.SPRITE_MYTHRIL_FENCE_SPRITESHEET, Paths.SPRITE_MYTHRIL_FENCE_SPRITESHEET, 1, 2, DEFAULT_STACK_SIZE, "Quintessential fencing made of mythril. Place fences adjacent to each other for best results.", 
                100, EntityType.FENCE, PlaceableItem.PlacementType.NORMAL, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            ...
            AddToDictionary(STONE_FENCE = new PlaceableItem("Stone Fence", Paths.ITEM_STONE_FENCE, Paths.ITEM_STONE_FENCE, Paths.SPRITE_STONE_FENCE_SPRITESHEET, Paths.SPRITE_STONE_FENCE_SPRITESHEET, 1, 2, DEFAULT_STACK_SIZE, "Gorgonic fencing made of stone. Good fences make good neighbors.",
                20, EntityType.FENCE, PlaceableItem.PlacementType.NORMAL, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            ...
            AddToDictionary(TALL_FENCE = new PlaceableItem("Tall Fence", Paths.ITEM_TALL_FENCE, Paths.ITEM_TALL_FENCE, Paths.SPRITE_TALL_FENCE_SPRITESHEET, Paths.SPRITE_TALL_FENCE_SPRITESHEET, 1, 3, DEFAULT_STACK_SIZE, "Towering fencing made of wood. Privacy restored!",
                25, EntityType.FENCE, PlaceableItem.PlacementType.NORMAL, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            AddToDictionary(GOLDEN_FENCE = new PlaceableItem("Golden Fence", Paths.ITEM_GOLDEN_FENCE, Paths.ITEM_GOLDEN_FENCE, Paths.SPRITE_GOLDEN_FENCE_SPRITESHEET, Paths.SPRITE_GOLDEN_FENCE_SPRITESHEET, 1, 2, DEFAULT_STACK_SIZE, "Midasian fencing made of gold. A bit gaudy, perhaps?",
                120, EntityType.FENCE, PlaceableItem.PlacementType.NORMAL, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            ...
            AddToDictionary(WAVE_WALLPAPER = new WallpaperItem("Wave Wallpaper", Paths.ITEM_WALLPAPER_WAVE, Paths.ITEM_WALLPAPER_WAVE,
                ...
                1, 1, DEFAULT_STACK_SIZE, "Do the wave!", 165, EntityType.WALLPAPER, PlaceableItem.PlacementType.WALLPAPER, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            AddToDictionary(STAR_WALLPAPER = new WallpaperItem("Star Wallpaper", Paths.ITEM_WALLPAPER_STAR, Paths.ITEM_WALLPAPER_STAR,
                ...
                Paths.SPRITE_WALLPAPER_STAR, Paths.SPRITE_WALLPAPER_STAR,
                Paths.SPRITE_WALLPAPER_STAR, Paths.SPRITE_WALLPAPER_STAR,
                1, 1, DEFAULT_STACK_SIZE, "One small step for man, one giant leap for your walls.", 95, EntityType.WALLPAPER, PlaceableItem.PlacementType.WALLPAPER, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            AddToDictionary(BUBBLE_WALLPAPER = new WallpaperItem("Bubble Wallpaper", Paths.ITEM_WALLPAPER_BUBBLE, Paths.ITEM_WALLPAPER_BUBBLE, 
                ...
                Paths.SPRITE_WALLPAPER_BUBBLE, Paths.SPRITE_WALLPAPER_BUBBLE,
                Paths.SPRITE_WALLPAPER_BUBBLE, Paths.SPRITE_WALLPAPER_BUBBLE,
                1, 1, DEFAULT_STACK_SIZE, "It makes you feel like you're underwater!", 80, EntityType.WALLPAPER, PlaceableItem.PlacementType.WALLPAPER, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            ...
            AddToDictionary(HORIZONTAL_WALLPAPER = new WallpaperItem("Horizontal Wallpaper", Paths.ITEM_WALLPAPER_HORIZONTAL, Paths.ITEM_WALLPAPER_HORIZONTAL,
                ...
                1, 1, DEFAULT_STACK_SIZE, "It's exactly what it says on the tin.", 90, EntityType.WALLPAPER, PlaceableItem.PlacementType.WALLPAPER, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            AddToDictionary(DOT_WALLPAPER = new WallpaperItem("Dot Wallpaper", Paths.ITEM_WALLPAPER_DOT, Paths.ITEM_WALLPAPER_DOT,
                ...
                1, 1, DEFAULT_STACK_SIZE, "This wallpaper doesn't take Damage Over Time in any way. It's long lasting!", 95, EntityType.WALLPAPER, PlaceableItem.PlacementType.WALLPAPER, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            AddToDictionary(POLKA_WALLPAPER = new WallpaperItem("Polka Wallpaper", Paths.ITEM_WALLPAPER_POLKA, Paths.ITEM_WALLPAPER_POLKA,
                ...
                1, 1, DEFAULT_STACK_SIZE, "Do the dance!", 90, EntityType.WALLPAPER, PlaceableItem.PlacementType.WALLPAPER, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            AddToDictionary(INVADER_WALLPAPER = new WallpaperItem("Invader Wallpaper", Paths.ITEM_WALLPAPER_INVADER, Paths.ITEM_WALLPAPER_INVADER,
                ...
                1, 1, DEFAULT_STACK_SIZE, "Modeled after retro arcade games.", 85, EntityType.WALLPAPER, PlaceableItem.PlacementType.WALLPAPER, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            AddToDictionary(ODD_WALLPAPER = new WallpaperItem("Odd Wallpaper", Paths.ITEM_WALLPAPER_ODD, Paths.ITEM_WALLPAPER_ODD,
                ...
                Paths.SPRITE_WALLPAPER_ODD, Paths.SPRITE_WALLPAPER_ODD,
                Paths.SPRITE_WALLPAPER_ODD, Paths.SPRITE_WALLPAPER_ODD,
                1, 1, DEFAULT_STACK_SIZE, "What is this pattern even supposed to be?", 70, EntityType.WALLPAPER, PlaceableItem.PlacementType.WALLPAPER, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            ...
            AddToDictionary(SCAFFOLDING_WOOD = new BuildingBlockItem("Wooden Scaffolding", Paths.ITEM_SCAFFOLDING_WOOD, Paths.ITEM_NONE, Paths.SPRITE_SCAFFOLDING_WOOD, Paths.ITEM_NONE, BlockType.SCAFFOLDING, DEFAULT_STACK_SIZE, "Scaffolding made of wood. I can place this on my farm to build structures.", 10, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            AddToDictionary(SCAFFOLDING_METAL = new BuildingBlockItem("Metal Scaffolding", Paths.ITEM_SCAFFOLDING_METAL, Paths.ITEM_NONE, Paths.SPRITE_SCAFFOLDING_METAL, Paths.ITEM_NONE, BlockType.SCAFFOLDING, DEFAULT_STACK_SIZE, "Chainlink made of iron. I can place this on my farm to build structures.", 50, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            AddToDictionary(SCAFFOLDING_GOLDEN = new BuildingBlockItem("Golden Scaffolding", Paths.ITEM_SCAFFOLDING_GOLDEN, Paths.ITEM_NONE, Paths.SPRITE_SCAFFOLDING_GOLDEN, Paths.ITEM_NONE, BlockType.SCAFFOLDING, DEFAULT_STACK_SIZE, "An ornate pattern made of gold. I can place this on my farm to build structures.", 120, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            AddToDictionary(SCAFFOLDING_MYTHRIL = new BuildingBlockItem("Mythril Scaffolding", Paths.ITEM_SCAFFOLDING_MYTHRIL, Paths.ITEM_NONE, Paths.SPRITE_SCAFFOLDING_MYTHRIL, Paths.ITEM_NONE, BlockType.SCAFFOLDING, DEFAULT_STACK_SIZE, "Bars made of mythril. I can place this on my farm to build structures.", 110, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            AddToDictionary(PLATFORM_WOOD = new BuildingBlockItem("Wooden Platform", Paths.ITEM_PLATFORM_WOOD, Paths.ITEM_NONE, Paths.SPRITE_PLATFORM_WOOD, Paths.ITEM_NONE, BlockType.PLATFORM, DEFAULT_STACK_SIZE, "Platform made of wood. I can place this on my farm to build structures. Platforms are solid on top.", 15, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            AddToDictionary(PLATFORM_STONE = new BuildingBlockItem("Stone Platform", Paths.ITEM_PLATFORM_STONE, Paths.ITEM_NONE, Paths.SPRITE_PLATFORM_STONE, Paths.ITEM_NONE, BlockType.PLATFORM, DEFAULT_STACK_SIZE, "Platform made of stone. I can place this on my farm to build structures. Platforms are solid on top.", 30, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            AddToDictionary(PLATFORM_METAL = new BuildingBlockItem("Metal Platform", Paths.ITEM_PLATFORM_METAL, Paths.ITEM_NONE, Paths.SPRITE_PLATFORM_METAL, Paths.ITEM_NONE, BlockType.PLATFORM, DEFAULT_STACK_SIZE, "Platform made of iron. I can place this on my farm to build structures. Platforms are solid on top.", 100, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            AddToDictionary(PLATFORM_GOLDEN = new BuildingBlockItem("Golden Platform", Paths.ITEM_PLATFORM_GOLDEN, Paths.ITEM_NONE, Paths.SPRITE_PLATFORM_GOLDEN, Paths.ITEM_NONE, BlockType.PLATFORM, DEFAULT_STACK_SIZE, "Platform made of gold. I can place this on my farm to build structures. Platforms are solid on top.", 240, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            AddToDictionary(PLATFORM_MYTHRIL = new BuildingBlockItem("Mythril Platform", Paths.ITEM_PLATFORM_MYTHRIL, Paths.ITEM_NONE, Paths.SPRITE_PLATFORM_MYTHRIL, Paths.ITEM_NONE, BlockType.PLATFORM, DEFAULT_STACK_SIZE, "Platform made of mythril. I can place on my farm this to build structures. Platforms are solid on top.", 210, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            AddToDictionary(PLATFORM_WOOD_FARM = new BuildingBlockItem("Wooden Farming Platform", Paths.ITEM_PLATFORM_WOOD_FARM, Paths.ITEM_NONE, Paths.SPRITE_PLATFORM_WOOD_FARM, Paths.ITEM_NONE, BlockType.PLATFORM_FARM, DEFAULT_STACK_SIZE, "Platform made of wood. I can place this on my farm to build structures. The dirt on the top is tillable soil.", 30, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            AddToDictionary(PLATFORM_METAL_FARM = new BuildingBlockItem("Metal Farming Platform", Paths.ITEM_PLATFORM_METAL_FARM, Paths.ITEM_NONE, Paths.SPRITE_PLATFORM_METAL_FARM, Paths.ITEM_NONE, BlockType.PLATFORM_FARM, DEFAULT_STACK_SIZE, "Platform made of iron. I can place this on my farm to build structures. The dirt on the top is tillable soil.", 150, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            AddToDictionary(PLATFORM_STONE_FARM = new BuildingBlockItem("Stone Farming Platform", Paths.ITEM_PLATFORM_STONE_FARM, Paths.ITEM_NONE, Paths.SPRITE_PLATFORM_STONE_FARM, Paths.ITEM_NONE, BlockType.PLATFORM_FARM, DEFAULT_STACK_SIZE, "Platform made of stone. I can place this on my farm to build structures. The dirt on the top is tillable soil.", 40, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            AddToDictionary(PLATFORM_GOLDEN_FARM = new BuildingBlockItem("Golden Farming Platform", Paths.ITEM_PLATFORM_GOLDEN_FARM, Paths.ITEM_NONE, Paths.SPRITE_PLATFORM_GOLDEN_FARM, Paths.ITEM_NONE, BlockType.PLATFORM_FARM, DEFAULT_STACK_SIZE, "Platform made of gold. I can place this on my farm to build structures. The dirt on the top is tillable soil.", 280, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            AddToDictionary(PLATFORM_MYTHRIL_FARM = new BuildingBlockItem("Mythril Farming Platform", Paths.ITEM_PLATFORM_MYTHRIL_FARM, Paths.ITEM_NONE, Paths.SPRITE_PLATFORM_MYTHRIL_FARM, Paths.ITEM_NONE, BlockType.PLATFORM_FARM, DEFAULT_STACK_SIZE, "Platform made of mythril. I can place this on my farm to build structures. The dirt on the top is tillable soil.", 250, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            AddToDictionary(BLOCK_WOOD = new BuildingBlockItem("Wooden Block", Paths.ITEM_BLOCK_WOOD, Paths.ITEM_NONE, Paths.SPRITE_BLOCK_WOOD, Paths.ITEM_NONE, BlockType.BLOCK, DEFAULT_STACK_SIZE, "A square block made of wood. I can place this on my farm to build structures.", 25, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            AddToDictionary(BLOCK_METAL = new BuildingBlockItem("Metal Block", Paths.ITEM_BLOCK_METAL, Paths.ITEM_NONE, Paths.SPRITE_BLOCK_METAL, Paths.ITEM_NONE, BlockType.BLOCK, DEFAULT_STACK_SIZE, "A metal block made of iron. I can place this on my farm to build structures.", 140, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            AddToDictionary(BLOCK_STONE = new BuildingBlockItem("Stone Block", Paths.ITEM_BLOCK_STONE, Paths.ITEM_NONE, Paths.SPRITE_BLOCK_STONE, Paths.ITEM_NONE, BlockType.BLOCK, DEFAULT_STACK_SIZE, "A solid block made of stone. I can place this on my farm to build structures.", 45, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            AddToDictionary(BLOCK_GOLDEN = new BuildingBlockItem("Golden Block", Paths.ITEM_BLOCK_GOLDEN, Paths.ITEM_NONE, Paths.SPRITE_BLOCK_GOLDEN, Paths.ITEM_NONE, BlockType.BLOCK, DEFAULT_STACK_SIZE, "A shining block made of gold. I can place this on my farm to build structures.", 360, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            AddToDictionary(BLOCK_MYTHRIL = new BuildingBlockItem("Mythril Block", Paths.ITEM_BLOCK_MYTHRIL, Paths.ITEM_NONE, Paths.SPRITE_BLOCK_MYTHRIL, Paths.ITEM_NONE, BlockType.BLOCK, DEFAULT_STACK_SIZE, "A blue block made of mythril. I can place on my farm this to build structures.", 310, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            AddToDictionary(WALL_STONE = new BuildingBlockItem("Stone Wall", Paths.ITEM_WALL_STONE, Paths.ITEM_NONE, Paths.SPRITE_WALL_STONE, Paths.ITEM_NONE, BlockType.SCAFFOLDING, DEFAULT_STACK_SIZE, "Walls made of stone. I can place this on my farm to build structures.", 15, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            AddToDictionary(WALL_METAL = new BuildingBlockItem("Metal Wall", Paths.ITEM_WALL_METAL, Paths.ITEM_NONE, Paths.SPRITE_WALL_METAL, Paths.ITEM_NONE, BlockType.SCAFFOLDING, DEFAULT_STACK_SIZE, "Walls made of metal. I can place this on my farm to build structures.", 10, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            AddToDictionary(WALL_PLANK = new BuildingBlockItem("Plank Wall", Paths.ITEM_WALL_PLANK, Paths.ITEM_NONE, Paths.SPRITE_WALL_PLANK, Paths.ITEM_NONE, BlockType.SCAFFOLDING, DEFAULT_STACK_SIZE, "Walls made from planks. I can place this on my farm to build structures.", 25, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            AddToDictionary(PLATFORM_PLANK = new BuildingBlockItem("Plank Platform", Paths.ITEM_PLATFORM_PLANK, Paths.ITEM_NONE, Paths.SPRITE_PLATFORM_PLANK, Paths.ITEM_NONE, BlockType.PLATFORM, DEFAULT_STACK_SIZE, "Platform made of planks. I can place this on my farm to build structures. Platforms are solid on top.", 35, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            AddToDictionary(BLOCK_PLANK = new BuildingBlockItem("Plank Block", Paths.ITEM_BLOCK_PLANK, Paths.ITEM_NONE, Paths.SPRITE_BLOCK_PLANK, Paths.ITEM_NONE, BlockType.BLOCK, DEFAULT_STACK_SIZE, "A crafty block made of planks. I can place this on my farm to build structures.", 50, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
            AddToDictionary(BLOCK_BARK = new BuildingBlockItem("Bark Block", Paths.ITEM_BLOCK_BARK, Paths.ITEM_NONE, Paths.SPRITE_BLOCK_BARK, Paths.ITEM_NONE, BlockType.BLOCK, DEFAULT_STACK_SIZE, "A natural block made of bark. I can place this on my farm to build structures.", 25, null, Item.Tag.DYEABLE, Item.Tag.MULTIDYE, Item.Tag.PLACEABLE));
