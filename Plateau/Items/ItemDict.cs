...
namespace Plateau.Items
{
    public class ItemDict
    {
        ...
        public static void LoadContent(ContentManager content)
        {
            ...
            AddToDictionary(RED_DYE = new DyeItem("Red Dye", Paths.ITEM_RED_DYE, DEFAULT_STACK_SIZE, Util.RED, "A sanguine vial of red colored dye. In your inventory, hold this and right click on clothes or furniture to apply it.", 100, Tag.DYE));
            ...
            AddToDictionary(UN_DYE = new DyeItem("Un-Dye", Paths.ITEM_UN_DYE, DEFAULT_STACK_SIZE, null, "A strange vial of dye-nullifying dye. In your inventory, hold this and right click on clothes or furniture to remove dye.", 80, Tag.DYE));
            ...
            AddToDictionary(BOWLER = new ClothingItem("Bowler", Paths.ITEM_BOWLER, Paths.ITEM_BOWLER, 1,"What do you think, detective?", 900, Paths.CLOTHING_BOWLER_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.HAT, Item.Tag.DYEABLE, Item.Tag.CLOTHING));
            ...
            AddToDictionary(ONESIE = new ClothingItem("Onesie", Paths.ITEM_ONESIE, Paths.ITEM_ONESIE, 1, "But what would a twosie look like?", 2200, Paths.CLOTHING_ONESIE_SPRITESHEET_DEFAULT, Paths.CLOTHING_NONE_SPRITESHEET, null, Item.Tag.OUTERWEAR, Item.Tag.DYEABLE, Item.Tag.CLOTHING, Item.Tag.SHIRT));
