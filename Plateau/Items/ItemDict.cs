...
namespace Plateau.Items
{
    public class ItemDict
    {
        ...
        public static void LoadContent(ContentManager content)
        {
            ...
            AddToDictionary(EMERALD_MOSS = new Item("Emerald Moss", Paths.ITEM_EMERALD_MOSS, DEFAULT_STACK_SIZE, "If exposed to sunlight for awhile, it glows in the dark. It can be crushed into dye.", 15, Tag.FORAGE));
            ...
            AddToDictionary(FRIED_EGG = new EdibleItem("Fried Egg", Paths.ITEM_FRIED_EGG, DEFAULT_STACK_SIZE, "Sunny side up!", AppliedEffects.GATHERING_CHICKEN, AppliedEffects.LENGTH_MEDIUM, "Delicious!", -9, Tag.FOOD, Tag.SALTY, Tag.BREAKFAST, Tag.CUISINE));
            AddToDictionary(EGG_SCRAMBLE = new EdibleItem("Egg Scramble", Paths.ITEM_EGG_SCRAMBLE, DEFAULT_STACK_SIZE, "They're all mixed up.", AppliedEffects.GATHERING_SHEEP, AppliedEffects.LENGTH_MEDIUM, "Delicious!", -9, Tag.FOOD, Tag.SALTY, Tag.BREAKFAST, Tag.CUISINE));
            AddToDictionary(BREAKFAST_POTATOES = new EdibleItem("Breakfast Potatoes", Paths.ITEM_BREAKFAST_POTATOES, DEFAULT_STACK_SIZE, "Cubed, not hashed.", AppliedEffects.SPEED_II_MORNING, AppliedEffects.LENGTH_MEDIUM, "Delicious!", -9, Tag.FOOD, Tag.SALTY, Tag.BREAKFAST, Tag.CUISINE));
            AddToDictionary(SPICY_BACON = new EdibleItem("Spicy Bacon", Paths.ITEM_SPICY_BACON, DEFAULT_STACK_SIZE, "Sizzling spicy!", AppliedEffects.SPEED_III_MORNING, AppliedEffects.LENGTH_SHORT, "Delicious!", -9, Tag.FOOD, Tag.SPICY, Tag.SALTY, Tag.BREAKFAST, Tag.CUISINE));
            AddToDictionary(BLUEBERRY_PANCAKES = new EdibleItem("Blueberry Pancakes", Paths.ITEM_BLUEBERRY_PANCAKES, DEFAULT_STACK_SIZE, "A classic pancake-fruit pairing.", AppliedEffects.SPEED_IV_MORNING, AppliedEffects.LENGTH_MEDIUM, "Delicious!", -9, Tag.FOOD, Tag.FRUITY, Tag.BREAKFAST, Tag.SWEET, Tag.CUISINE));
            AddToDictionary(APPLE_MUFFIN = new EdibleItem("Apple Muffin", Paths.ITEM_APPLE_MUFFIN, DEFAULT_STACK_SIZE, "Freshly baked!", AppliedEffects.SPEED_IV_AUTUMN, AppliedEffects.LENGTH_MEDIUM, "Delicious!", -9, Tag.FOOD, Tag.BREAKFAST, Tag.SWEET, Tag.BREAKFAST, Tag.FRUITY, Tag.CUISINE));
            AddToDictionary(ROASTED_PUMPKIN = new EdibleItem("Roasted Pumpkin", Paths.ITEM_ROASTED_PUMPKIN, DEFAULT_STACK_SIZE, "Crispy out the outside, yet tender in the middle.", AppliedEffects.CHOPPING_III, AppliedEffects.LENGTH_MEDIUM, "Delicious!", -9, Tag.FOOD, Tag.SALTY, Tag.VEGGIE, Tag.CUISINE));
            AddToDictionary(VEGGIE_SIDE_ROAST = new EdibleItem("Veggie Side Roast", Paths.ITEM_VEGGIE_SIDE_ROAST, DEFAULT_STACK_SIZE, "A variety of veggies to go with your meal!", AppliedEffects.FORAGING_III_AUTUMN, AppliedEffects.LENGTH_MEDIUM, "Delicious!", -9, Tag.FOOD, Tag.VEGGIE, Tag.CUISINE));
            AddToDictionary(WRAPPED_CABBAGE = new EdibleItem("Wrapped Cabbage", Paths.ITEM_WRAPPED_CABBAGE, DEFAULT_STACK_SIZE, "These cabbage rolls combine leafy greens with savory meat.", AppliedEffects.MINING_IV, AppliedEffects.LENGTH_MEDIUM, "Delicious!", -9, Tag.FOOD, Tag.MEATY, Tag.VEGGIE, Tag.CUISINE));
            AddToDictionary(SEAFOOD_PAELLA = new EdibleItem("Seafood Paella", Paths.ITEM_SEAFOOD_PAELLA, DEFAULT_STACK_SIZE, "A delicious collection of the ocean's greatest hits, all over rice.", AppliedEffects.MINING_IV, AppliedEffects.LENGTH_LONG, "Delicious!", -9, Tag.FOOD, Tag.SEAFOOD, Tag.MEATY, Tag.CUISINE));
            AddToDictionary(SEASONAL_PIPERADE = new EdibleItem("Seasonal Piperade", Paths.ITEM_SEASONAL_PIPERADE, DEFAULT_STACK_SIZE, "Do you think Piper would appreciate this?", AppliedEffects.CHOPPING_IV, AppliedEffects.LENGTH_MEDIUM, "Delicious!", -9, Tag.FOOD, Tag.VEGGIE, Tag.CUISINE));
            AddToDictionary(SUPER_JUICE = new EdibleItem("Super Juice", Paths.ITEM_SUPER_JUICE, DEFAULT_STACK_SIZE, "Contains all 14 essential vitamins!", AppliedEffects.CHOPPING_VI, AppliedEffects.LENGTH_VERY_SHORT, "Delicious!", -9, Tag.FOOD, Tag.VEGGIE, Tag.DRINK, Tag.BITTER, Tag.CUISINE));
            AddToDictionary(POTATO_AND_BEET_FRIES = new EdibleItem("Potato & Beet Fries", Paths.ITEM_POTATO_AND_BEET_FRIES, DEFAULT_STACK_SIZE, "The mixture of fried beets and potatoes provides some nice variety to typical potato fries.", AppliedEffects.FORAGING_III, AppliedEffects.LENGTH_SHORT, "Delicious!", -9, Tag.FOOD, Tag.SALTY, Tag.VEGGIE, Tag.BREAKFAST, Tag.CUISINE));
            AddToDictionary(PICKLED_BEET_EGGS = new EdibleItem("Pickled Beet Eggs", Paths.ITEM_PICKLED_BEET_EGGS, DEFAULT_STACK_SIZE, "\"Pickled\" using an unconventional speed-brine technique. The secret is in the oils of crushed up spicy leaf.", AppliedEffects.GATHERING_CHICKEN, AppliedEffects.LENGTH_SHORT, "Delicious!", -9, Tag.FOOD, Tag.SPICY, Tag.BREAKFAST, Tag.SWEET, Tag.CUISINE));
            AddToDictionary(COCONUT_BOAR = new EdibleItem("Coconut Boar", Paths.ITEM_COCONUT_BOAR, DEFAULT_STACK_SIZE, "A unique combination of tropical seasoning and mountainous meat. And it's huge!", AppliedEffects.MINING_V, AppliedEffects.LENGTH_VERY_LONG, "Delicious!", -9, Tag.FOOD, Tag.MEATY, Tag.SWEET, Tag.CUISINE));
            AddToDictionary(SPRING_PIZZA = new EdibleItem("Spring Pizza", Paths.ITEM_SPRING_PIZZA, DEFAULT_STACK_SIZE, "Thin-crusted pizza made from springtime plants.", AppliedEffects.FORAGING_II, AppliedEffects.LENGTH_VERY_LONG, "Delicious!", -9, Tag.FOOD, Tag.VEGGIE, Tag.CUISINE));
            AddToDictionary(STRAWBERRY_SALAD = new EdibleItem("Strawberry Salad", Paths.ITEM_STRAWBERRY_SALAD, DEFAULT_STACK_SIZE, "The sweet strawberries help spruce up this salad!", AppliedEffects.FORAGING_IV_SPRING, AppliedEffects.LENGTH_LONG, "Delicious!", -9, Tag.FOOD, Tag.SWEET, Tag.VEGGIE, Tag.FRUITY, Tag.CUISINE));
            AddToDictionary(BOAR_STEW = new EdibleItem("Boar Stew", Paths.ITEM_BOAR_STEW, DEFAULT_STACK_SIZE, "A hearty stew made from boar, potatoes, and carrots. Extremely filling.", AppliedEffects.GATHERING_BOAR, AppliedEffects.LENGTH_VERY_LONG, "Delicious!", -9, Tag.FOOD, Tag.MEATY, Tag.CUISINE));
            AddToDictionary(BAKED_POTATO = new EdibleItem("Baked Potato", Paths.ITEM_BAKED_POTATO, DEFAULT_STACK_SIZE, "A classic! Stuffed with melted butter.", AppliedEffects.MINING_II, AppliedEffects.LENGTH_MEDIUM, "Delicious!", -9, Tag.FOOD, Tag.VEGGIE, Tag.SALTY, Tag.CUISINE));
            AddToDictionary(FRESH_SALAD = new EdibleItem("Fresh Salad", Paths.ITEM_FRESH_SALAD, DEFAULT_STACK_SIZE, "The combination of diced watermelon, cucumber, and tomatoes make this an incredibly refreshing dish.", AppliedEffects.FORAGING_V_FLOWERS, AppliedEffects.LENGTH_MEDIUM, "Delicious!", -9, Tag.FOOD, Tag.VEGGIE, Tag.CUISINE));
            AddToDictionary(STEWED_VEGGIES = new EdibleItem("Stewed Veggies", Paths.ITEM_STEWED_VEGGIES, DEFAULT_STACK_SIZE, "A combination of stewed summer vegetables. Stewed cucumber is surprisingly delicious!", AppliedEffects.CHOPPING_III, AppliedEffects.LENGTH_LONG, "Delicious!", -9, Tag.FOOD, Tag.VEGGIE, Tag.CUISINE));
            AddToDictionary(MEATY_PIZZA = new EdibleItem("Meaty Pizza", Paths.ITEM_MEATY_PIZZA, DEFAULT_STACK_SIZE, "This pizza is covered in savory meats!", AppliedEffects.MINING_III, AppliedEffects.LENGTH_VERY_LONG, "Delicious!", -9, Tag.FOOD, Tag.MEATY, Tag.SALTY, Tag.CUISINE));
            AddToDictionary(WATERMELON_ICE = new EdibleItem("Watermelon Ice", Paths.ITEM_WATERMELON_ICE, DEFAULT_STACK_SIZE, "Shaved ice flavored with watermelon juice. Nothing can hit the spot better on a sunny day than this!", AppliedEffects.SPEED_III, AppliedEffects.LENGTH_SHORT, "Delicious!", -9, Tag.FOOD, Tag.SWEET, Tag.FRUITY, Tag.CUISINE));
            AddToDictionary(SUSHI_ROLL = new EdibleItem("Sushi Roll", Paths.ITEM_SUSHI_ROLL, DEFAULT_STACK_SIZE, "A custom roll of maki sushi. Chef's choice of fish.", AppliedEffects.FISHING_II, AppliedEffects.LENGTH_MEDIUM, "Delicious!", -9, Tag.FOOD, Tag.SALTY, Tag.SEAFOOD, Tag.CUISINE));
            AddToDictionary(SEARED_TUNA = new EdibleItem("Seared Tuna", Paths.ITEM_SEARED_TUNA, DEFAULT_STACK_SIZE, "Although the outside of this tuna is seared, the inside is still rare.", AppliedEffects.FISHING_V_OCEAN, AppliedEffects.LENGTH_VERY_LONG, "Delicious!", -9, Tag.FOOD, Tag.SEAFOOD, Tag.SPICY, Tag.CUISINE));
            AddToDictionary(DELUXE_SUSHI = new EdibleItem("Deluxe Sushi", Paths.ITEM_DELUXE_SUSHI, DEFAULT_STACK_SIZE, "A deluxe roll of maki sushi. Made with high quality fish!", AppliedEffects.FISHING_III, AppliedEffects.LENGTH_MEDIUM, "Delicious!", -9, Tag.FOOD, Tag.SEAFOOD, Tag.SALTY, Tag.CUISINE));
            AddToDictionary(MUSHROOM_STIR_FRY = new EdibleItem("Mushroom Stir Fry", Paths.ITEM_MUSHROOM_STIR_FRY, DEFAULT_STACK_SIZE, "The copious amount of mushrooms added to this stir fry contribute their earthy flavor to the dish.", AppliedEffects.FORAGING_IV_MUSHROOMS, AppliedEffects.LENGTH_MEDIUM, "Delicious!", -9, Tag.FOOD, Tag.SALTY, Tag.VEGGIE, Tag.CUISINE));
            AddToDictionary(MOUNTAIN_TERIYAKI = new EdibleItem("Mountain Teriyaki", Paths.ITEM_MOUNTAIN_TERIYAKI, DEFAULT_STACK_SIZE, "Boar meat glazed with a sweet sauce. It's a Nimbus-Fusion classic!", AppliedEffects.MINING_VI, AppliedEffects.LENGTH_MEDIUM, "Delicious!", -9, Tag.FOOD, Tag.MEATY, Tag.SWEET, Tag.CUISINE));
            AddToDictionary(LETHAL_SASHIMI = new EdibleItem("Lethal Sashimi", Paths.ITEM_LETHAL_SASHIMI, DEFAULT_STACK_SIZE, "Supposedly, the pufferfish venom was removed before rolling. Supposedly.", AppliedEffects.SPEED_V, AppliedEffects.LENGTH_VERY_SHORT, "Delicious!", -9, Tag.FOOD, Tag.MEATY, Tag.SEAFOOD, Tag.SWEET, Tag.SALTY, Tag.CUISINE));
            AddToDictionary(VANILLA_ICECREAM = new EdibleItem("Vanilla Ice Cream", Paths.ITEM_VANILLA_ICECREAM, DEFAULT_STACK_SIZE, "Sweet, sugarly, and cold.", AppliedEffects.FORAGING_V_WINTER, AppliedEffects.LENGTH_SHORT, "Delicious!", -9, Tag.FOOD, Tag.SWEET, Tag.CUISINE));
            AddToDictionary(BERRY_MILKSHAKE = new EdibleItem("Berry Milkshake", Paths.ITEM_BERRY_MILKSHAKE, DEFAULT_STACK_SIZE, "The blended wild berries add a fruity touch.", AppliedEffects.SPEED_III, AppliedEffects.LENGTH_SHORT, "Delicious!", -9, Tag.FOOD, Tag.SWEET, Tag.DRINK, Tag.FRUITY, Tag.CUISINE));
            AddToDictionary(MINT_CHOCO_BAR = new EdibleItem("Mint-Choco Bar", Paths.ITEM_MINT_CHOCO_BAR, DEFAULT_STACK_SIZE, "A classic combination of mint and chocolate, wrapped up into a conveniently pocket-sized ice cream bar.", AppliedEffects.SPEED_III, AppliedEffects.LENGTH_MEDIUM, "Delicious!", -9, Tag.FOOD, Tag.SWEET, Tag.CUISINE));
            AddToDictionary(MINTY_MELT = new EdibleItem("Minty Melt", Paths.ITEM_MINTY_MELT, DEFAULT_STACK_SIZE, "Eat it! Quickly, before it melts any further!", AppliedEffects.SPEED_III, AppliedEffects.LENGTH_SHORT, "Delicious!", -9, Tag.FOOD, Tag.SWEET, Tag.CUISINE));
            AddToDictionary(BANANA_SUNDAE = new EdibleItem("Banana Sundae", Paths.ITEM_BANANA_SUNDAE, DEFAULT_STACK_SIZE, "A sunday classic!", AppliedEffects.SPEED_V_WINTER, AppliedEffects.LENGTH_SHORT, "Delicious!", -9, Tag.FOOD, Tag.SWEET, Tag.FRUITY, Tag.CUISINE));
            AddToDictionary(FRENCH_ONION_SOUP = new EdibleItem("French Onion Soup", Paths.ITEM_FRENCH_ONION_SOUP, DEFAULT_STACK_SIZE, "An exquisite soup topped with cheese.", AppliedEffects.FORAGING_III_FLOWERS, AppliedEffects.LENGTH_SHORT, "Delicious!", -9, Tag.FOOD, Tag.VEGGIE, Tag.SALTY, Tag.CUISINE));
            AddToDictionary(TOMATO_SOUP = new EdibleItem("Tomato Soup", Paths.ITEM_TOMATO_SOUP, DEFAULT_STACK_SIZE, "Probably the easiest soup ever.", AppliedEffects.CHOPPING_III, AppliedEffects.LENGTH_MEDIUM, "Delicious!", -9, Tag.FOOD, Tag.VEGGIE, Tag.CUISINE));
            AddToDictionary(FARMERS_STEW = new EdibleItem("Farmer's Stew", Paths.ITEM_FARMERS_STEW, DEFAULT_STACK_SIZE, "This standard Nimbus Town recipe uses three different vegetables!", AppliedEffects.FORAGING_III, AppliedEffects.LENGTH_LONG, "Delicious!", -9, Tag.FOOD, Tag.VEGGIE, Tag.CUISINE));
            AddToDictionary(CREAM_OF_MUSHROOM = new EdibleItem("Cream of Mushroom", Paths.ITEM_CREAM_OF_MUSHROOM, DEFAULT_STACK_SIZE, "It's as close to liquid mushrooms as you can get.", AppliedEffects.FORAGING_VI_MUSHROOMS, AppliedEffects.LENGTH_SHORT, "Delicious!", -9, Tag.FOOD, Tag.VEGGIE, Tag.CUISINE));
            AddToDictionary(CREAMY_SPINACH = new EdibleItem("Creamy Spinach", Paths.ITEM_CREAMY_SPINACH, DEFAULT_STACK_SIZE, "The spinach adds an earthy flavor to this creamy soup.", AppliedEffects.GATHERING_COW, AppliedEffects.LENGTH_SHORT, "Delicious!", -9, Tag.FOOD, Tag.VEGGIE, Tag.CUISINE));
            AddToDictionary(SHRIMP_GUMBO = new EdibleItem("Shrimp Gumbo", Paths.ITEM_SHRIMP_GUMBO, DEFAULT_STACK_SIZE, "Spicy but delicious!", AppliedEffects.CHOPPING_V, AppliedEffects.LENGTH_LONG, "Delicious!", -9, Tag.FOOD, Tag.SEAFOOD, Tag.SPICY, Tag.CUISINE));
            AddToDictionary(FRIED_CATFISH = new EdibleItem("Fried Catfish", Paths.ITEM_FRIED_CATFISH, DEFAULT_STACK_SIZE, "Is there any other way to prepare Catfish?", AppliedEffects.FISHING_IV_FRESHWATER, AppliedEffects.LENGTH_LONG, "Delicious!", -9, Tag.FOOD, Tag.SEAFOOD, Tag.CUISINE));
            AddToDictionary(GRILLED_SALMON = new EdibleItem("Grilled Salmon", Paths.ITEM_GRILLED_SALMON, DEFAULT_STACK_SIZE, "Perfectly grilled with a sauce of lemon butter on top.", AppliedEffects.FISHING_IV, AppliedEffects.LENGTH_MEDIUM, "Delicious!", -9, Tag.FOOD, Tag.SEAFOOD, Tag.CUISINE));
            AddToDictionary(BAKED_SNAPPER = new EdibleItem("Baked Snapper", Paths.ITEM_BAKED_SNAPPER, DEFAULT_STACK_SIZE, "It's stuffed with healthy spinach!", AppliedEffects.FISHING_IV_OCEAN, AppliedEffects.LENGTH_LONG, "Delicious!", -9, Tag.FOOD, Tag.SEAFOOD, Tag.CUISINE));
            AddToDictionary(SWORDFISH_POT = new EdibleItem("Swordfish Pot", Paths.ITEM_SWORDFISH_POT, DEFAULT_STACK_SIZE, "It's hotpot style with an eye-catching swordfish taking center stage.", AppliedEffects.FISHING_V, AppliedEffects.LENGTH_LONG, "Delicious!", -9, Tag.FOOD, Tag.SEAFOOD, Tag.CUISINE));
            AddToDictionary(HONEY_STIR_FRY = new EdibleItem("Honey Stir Fry", Paths.ITEM_HONEY_STIR_FRY, DEFAULT_STACK_SIZE, "This peppers & meat stirfry includes honey for sweetness.", AppliedEffects.GATHERING_BOAR, AppliedEffects.LENGTH_MEDIUM, "Delicious!", -9, Tag.FOOD, Tag.SWEET, Tag.VEGGIE, Tag.CUISINE));
            AddToDictionary(BUTTERED_ROLLS = new EdibleItem("Buttered Rolls", Paths.ITEM_BUTTERED_ROLLS, DEFAULT_STACK_SIZE, "Traditional rolls, baked fresh and ready to eat!", AppliedEffects.MINING_III, AppliedEffects.LENGTH_SHORT, "Delicious!", -9, Tag.FOOD, Tag.BREAKFAST, Tag.CUISINE));
            AddToDictionary(SAVORY_ROAST = new EdibleItem("Savory Roast", Paths.ITEM_SAVORY_ROAST, DEFAULT_STACK_SIZE, "This took a long time to roast. It's worth taking the time to savor it.", AppliedEffects.MINING_IV, AppliedEffects.LENGTH_LONG, "Delicious!", -9, Tag.FOOD, Tag.MEATY, Tag.CUISINE));
            AddToDictionary(STUFFED_FLOUNDER = new EdibleItem("Stuffed Flounder", Paths.ITEM_STUFFED_FLOUNDER, DEFAULT_STACK_SIZE, "This flouder is packed full of lobster and crab!", AppliedEffects.FISHING_IV_CLOUD, AppliedEffects.LENGTH_LONG, "Delicious!", -9, Tag.FOOD, Tag.SEAFOOD, Tag.CUISINE));
            AddToDictionary(CLAM_LINGUINI = new EdibleItem("Clam Linguini", Paths.ITEM_CLAM_LINGUINI, DEFAULT_STACK_SIZE, "The definitive seafood pasta dish. Nothing else comes close.", AppliedEffects.FORAGING_III_BEACH, AppliedEffects.LENGTH_MEDIUM, "Delicious!", -9, Tag.FOOD, Tag.SEAFOOD, Tag.CUISINE));
            AddToDictionary(LEMON_SHORTCAKE = new EdibleItem("Lemon Shortcake", Paths.ITEM_LEMON_SHORTCAKE, DEFAULT_STACK_SIZE, "The sweet and sour notes of lemon permeate this dense cake.", AppliedEffects.SPEED_IV_AUTUMN, AppliedEffects.LENGTH_SHORT, "Delicious!", -9, Tag.FOOD, Tag.SWEET, Tag.FRUITY, Tag.CUISINE));
            AddToDictionary(CHERRY_CHEESECAKE = new EdibleItem("Cherry Cheesecake", Paths.ITEM_CHERRY_CHEESECAKE, DEFAULT_STACK_SIZE, "A creamy cheesecake topped with fresh cherries.", AppliedEffects.SPEED_III_SPRING, AppliedEffects.LENGTH_MEDIUM, "Delicious!", -9, Tag.FOOD, Tag.SWEET, Tag.FRUITY, Tag.CUISINE));
            AddToDictionary(MOUNTAIN_BREAD = new EdibleItem("Mountain Bread", Paths.ITEM_MOUNTAIN_BREAD, DEFAULT_STACK_SIZE, "This hearty bread is dense and filling, though somewhat devoid of flavor.", AppliedEffects.CHOPPING_I, AppliedEffects.LENGTH_VERY_LONG, "Delicious!", -9, Tag.FOOD, Tag.BREAKFAST, Tag.CUISINE));
            AddToDictionary(CHICKWEED_BLEND = new EdibleItem("Chickweed Blend", Paths.ITEM_CHICKWEED_BLEND, DEFAULT_STACK_SIZE, "This salad is made from wild chickweed and spinach leaves.", AppliedEffects.FORAGING_III_SPRING, AppliedEffects.LENGTH_SHORT, "Delicious!", -9, Tag.FOOD, Tag.VEGGIE, Tag.CUISINE));
            AddToDictionary(CRISPY_GRASSHOPPER = new EdibleItem("Crispy Grasshopper", Paths.ITEM_CRISPY_GRASSHOPPER, DEFAULT_STACK_SIZE, "Fried grasshopper has a taste that can primarily be described as \"crunchy\".", AppliedEffects.BUG_CATCHING_II, AppliedEffects.LENGTH_SHORT, "Delicious!", -9, Tag.FOOD, Tag.SALTY, Tag.SPICY, Tag.CUISINE));
            AddToDictionary(REJUVENATION_TEA = new EdibleItem("Rejuvenation Tea", Paths.ITEM_REJUVENATION_TEA, DEFAULT_STACK_SIZE, "This healthy tea includes a surprisingly spicy bite.", AppliedEffects.SPEED_II, AppliedEffects.LENGTH_SHORT, "Delicious!", -9, Tag.FOOD, Tag.DRINK, Tag.BITTER, Tag.SPICY, Tag.CUISINE));
            AddToDictionary(HOMESTYLE_JELLY = new EdibleItem("\"Homestyle\" Jelly", Paths.ITEM_HOMESTYLE_JELLY, DEFAULT_STACK_SIZE, "It's basically what would happen if you made mashed potatoes with fruit.", AppliedEffects.SPEED_IV_SPRING, AppliedEffects.LENGTH_SHORT, "Delicious!", -9, Tag.FOOD, Tag.SWEET, Tag.BREAKFAST, Tag.FRUITY, Tag.CUISINE));
            AddToDictionary(SEAFOOD_BASKET = new EdibleItem("Seafood Basket", Paths.ITEM_SEAFOOD_BASKET, DEFAULT_STACK_SIZE, "A basket full of fried seafood! Bad for your weight, good for your soul!", AppliedEffects.FORAGING_IV_BEACH, AppliedEffects.LENGTH_MEDIUM, "Delicious!", -9, Tag.FOOD, Tag.SEAFOOD, Tag.SALTY, Tag.SPICY, Tag.CUISINE));
            AddToDictionary(WILD_POPCORN = new EdibleItem("Wild Popcorn", Paths.ITEM_WILD_POPCORN, DEFAULT_STACK_SIZE, "Made from wild maize, then coated with butter and chunks of salt.", AppliedEffects.CHOPPING_II, AppliedEffects.LENGTH_SHORT, "Delicious!", -9, Tag.FOOD, Tag.SALTY, Tag.VEGGIE, Tag.CUISINE));
            AddToDictionary(ELDERBERRY_TART = new EdibleItem("Elderberry Tart", Paths.ITEM_ELDERBERRY_TART, DEFAULT_STACK_SIZE, "A tart tart made from elderberries.", AppliedEffects.FORAGING_III_AUTUMN, AppliedEffects.LENGTH_SHORT, "Delicious!", -9, Tag.FOOD, Tag.SWEET, Tag.BREAKFAST, Tag.FRUITY, Tag.CUISINE));
            AddToDictionary(DARK_TEA = new EdibleItem("Dark Tea", Paths.ITEM_DARK_TEA, DEFAULT_STACK_SIZE, "Tea made from seeping sassafras leaves. The flavor is exceedingly strong.", AppliedEffects.FORAGING_II_WINTER, AppliedEffects.LENGTH_SHORT, "Delicious!", -9, Tag.FOOD, Tag.BITTER, Tag.DRINK, Tag.CUISINE));
            AddToDictionary(LICHEN_JUICE = new EdibleItem("Lichen Juice", Paths.ITEM_LICHEN_JUICE, DEFAULT_STACK_SIZE, "Earthy juice concocted from moss. Looks better than it smells, smells better than it tastes.", AppliedEffects.MINING_II, AppliedEffects.LENGTH_SHORT, "Delicious!", -9, Tag.FOOD, Tag.BITTER, Tag.DRINK, Tag.CUISINE));
            AddToDictionary(AUTUMN_MASH = new EdibleItem("Autumn Mash", Paths.ITEM_AUTUMN_MASH, DEFAULT_STACK_SIZE, "An extremely sweet variant of mashed potatoes composed of oranges and persimmons.", AppliedEffects.SPEED_III_AUTUMN, AppliedEffects.LENGTH_MEDIUM, "Delicious!", -9, Tag.FOOD, Tag.VEGGIE, Tag.FRUITY, Tag.CUISINE));
            AddToDictionary(CAMPFIRE_COFFEE = new EdibleItem("Campfire Coffee", Paths.ITEM_CAMPFIRE_COFFEE, DEFAULT_STACK_SIZE, "Brewed from chicory root. A standard survivalist drink.", AppliedEffects.SPEED_III_WINTER, AppliedEffects.LENGTH_SHORT, "Delicious!", -9, Tag.FOOD, Tag.DRINK, Tag.BITTER, Tag.CUISINE));
            AddToDictionary(BLIND_DINNER = new EdibleItem("Blind Dinner", Paths.ITEM_BLIND_DINNER, DEFAULT_STACK_SIZE, "A dish starring blind fish from caves where the sun doesn't shine.", AppliedEffects.FISHING_VI_CAVE, AppliedEffects.LENGTH_LONG, "Delicious!", -9, Tag.FOOD, Tag.SEAFOOD, Tag.SALTY, Tag.BITTER, Tag.CUISINE));
            AddToDictionary(FRIED_FISH = new EdibleItem("Fried Fish", Paths.ITEM_FRIED_FISH, DEFAULT_STACK_SIZE, "Deep fried to perfection!", AppliedEffects.FISHING_III_FRESHWATER, AppliedEffects.LENGTH_MEDIUM, "Delicious!", -9, Tag.FOOD, Tag.SEAFOOD, Tag.SALTY, Tag.CUISINE));
            AddToDictionary(SARDINE_SNACK = new EdibleItem("Sardine Snack", Paths.ITEM_SARDINE_SNACK, DEFAULT_STACK_SIZE, "Also contains herring and striped bass.", AppliedEffects.FISHING_III_OCEAN, AppliedEffects.LENGTH_MEDIUM, "Delicious!", -9, Tag.FOOD, Tag.SEAFOOD, Tag.SALTY, Tag.CUISINE));
            AddToDictionary(DWARVEN_STEW = new EdibleItem("Dwarven Stew", Paths.ITEM_DWARVEN_STEW, DEFAULT_STACK_SIZE, "This stew contains onions and rare mountain mushrooms.", AppliedEffects.GATHERING_PIG, AppliedEffects.LENGTH_VERY_LONG, "Delicious!", -9, Tag.FOOD, Tag.MEATY, Tag.CUISINE));
            AddToDictionary(SWEET_COCO_TREAT = new EdibleItem("Sweet Coco Treat", Paths.ITEM_SWEET_COCO_TREAT, DEFAULT_STACK_SIZE, "A homemade snackbar made of coconut, vanilla, and honey.", AppliedEffects.SPEED_III, AppliedEffects.LENGTH_SHORT, "Delicious!", -9, Tag.FOOD, Tag.SWEET, Tag.CUISINE));
            AddToDictionary(FRIED_OYSTERS = new EdibleItem("Fried Oysters", Paths.ITEM_FRIED_OYSTERS, DEFAULT_STACK_SIZE, "Fresh from the beach, with just a hint of grit.", AppliedEffects.FISHING_III_OCEAN, AppliedEffects.LENGTH_SHORT, "Delicious!", -9, Tag.FOOD, Tag.SALTY, Tag.SEAFOOD, Tag.CUISINE));
            AddToDictionary(SURVIVORS_SURPRISE = new EdibleItem("Survivor's Surprise", Paths.ITEM_SURVIVORS_SURPRISE, DEFAULT_STACK_SIZE, "The surprise is that it actually doesn't taste half bad, for something made of ants and worms.", AppliedEffects.BUG_CATCHING_III, AppliedEffects.LENGTH_LONG, "Delicious!", -9, Tag.FOOD, Tag.BITTER, Tag.CUISINE));
            AddToDictionary(EEL_ROLL = new EdibleItem("Eel Roll", Paths.ITEM_EEL_ROLL, DEFAULT_STACK_SIZE, "An exotic piece of eel nigiri.", AppliedEffects.FISHING_IV, AppliedEffects.LENGTH_SHORT, "Delicious!", -9, Tag.FOOD, Tag.SWEET, Tag.SALTY, Tag.SEAFOOD, Tag.CUISINE));
            AddToDictionary(RAW_CALAMARI = new EdibleItem("\"Raw\" Calamari", Paths.ITEM_RAW_CALAMARI, DEFAULT_STACK_SIZE, "There's no need to cook an octopus that lived its whole life in lava. Somehow the texture raw is already crunchy.", AppliedEffects.FISHING_III_LAVA, AppliedEffects.LENGTH_MEDIUM, "Delicious!", -9, Tag.FOOD, Tag.SALTY, Tag.SEAFOOD, Tag.CUISINE));
            AddToDictionary(STORMFISH = new EdibleItem("Stormfish", Paths.ITEM_STORMFISH, DEFAULT_STACK_SIZE, "Fried sky koi coated with large salt crystals. Very spicy.", AppliedEffects.FISHING_VI_CLOUD, AppliedEffects.LENGTH_LONG, "Delicious!", -9, Tag.FOOD, Tag.SALTY, Tag.SPICY, Tag.SEAFOOD, Tag.CUISINE));
            AddToDictionary(CREAMY_SQUID = new EdibleItem("Creamy Squid", Paths.ITEM_CREAMY_SQUID, DEFAULT_STACK_SIZE, "An unique dish made from magma squid and cream.", AppliedEffects.FISHING_VI_LAVA, AppliedEffects.LENGTH_MEDIUM, "Delicious!", -9, Tag.FOOD, Tag.SWEET, Tag.SEAFOOD, Tag.CUISINE));
            AddToDictionary(ESCARGOT = new EdibleItem("Escargot", Paths.ITEM_ESCARGOT, DEFAULT_STACK_SIZE, "Cooked snails served in shell, with a buttery sauce.", AppliedEffects.BUG_CATCHING_II, AppliedEffects.LENGTH_MEDIUM, "Delicious!", -9, Tag.FOOD, Tag.CUISINE));
            AddToDictionary(LUMINOUS_STEW = new EdibleItem("Luminous Stew", Paths.ITEM_LUMINOUS_STEW, DEFAULT_STACK_SIZE, "The liquid itself is glowing...", AppliedEffects.BUG_CATCHING_VI_NIGHT, AppliedEffects.LENGTH_LONG, "Delicious!", -9, Tag.FOOD, Tag.BITTER, Tag.CUISINE));
            AddToDictionary(COLESLAW = new EdibleItem("Coleslaw", Paths.ITEM_COLESLAW, DEFAULT_STACK_SIZE, "Traditional slaw made from cabbage, carrots, and mayo.", AppliedEffects.CHOPPING_IV, AppliedEffects.LENGTH_SHORT, "Delicious!", -9, Tag.FOOD, Tag.SWEET, Tag.CUISINE));
            AddToDictionary(RATATOUILLE = new EdibleItem("Ratatouille", Paths.ITEM_RATATOUILLE, DEFAULT_STACK_SIZE, "A dish made from stacked eggplant, tomatoes, and peppers. Rats love it too.", AppliedEffects.BUG_CATCHING_IV, AppliedEffects.LENGTH_MEDIUM, "Delicious!", -9, Tag.FOOD, Tag.SAVORY, Tag.VEGGIE, Tag.CUISINE));
            AddToDictionary(EGGPLANT_PARMESAN = new EdibleItem("Eggplant Parmesan", Paths.ITEM_EGGPLANT_PARMESAN, DEFAULT_STACK_SIZE, "Eggplant baked with cheese. Rich and flavorful.", AppliedEffects.FORAGING_IV_SUMMER, AppliedEffects.LENGTH_MEDIUM, "Delicious!", -9, Tag.FOOD, Tag.SAVORY, Tag.VEGGIE, Tag.CUISINE));

            AddToDictionary(BOAR_JERKY = new EdibleItem("Boar Jerky", Paths.ITEM_BOAR_JERKY, DEFAULT_STACK_SIZE, "This jerky was made from mountain boars. It's tougher and more gamey than traditional beef jerky.", AppliedEffects.MINING_I, AppliedEffects.LENGTH_VERY_LONG, "Delicious!", -9, Tag.FOOD, Tag.SALTY, Tag.MEATY, Tag.CUISINE));
            AddToDictionary(KLIPPFISK = new EdibleItem("Klippfisk", Paths.ITEM_KLIPPFISK, DEFAULT_STACK_SIZE, "Fish preserved in open air with salt and sun. The smell is strong, but the flavor is stronger. Can be reconstituted with water.", AppliedEffects.FISHING_I, AppliedEffects.LENGTH_VERY_LONG, "Delicious!", -9, Tag.FOOD, Tag.SALTY, Tag.CUISINE));
            AddToDictionary(DRIED_APPLE = new EdibleItem("Dried Apple", Paths.ITEM_DRIED_APPLE, DEFAULT_STACK_SIZE, "These slices of dried apple are perfect for a quick snack.", AppliedEffects.FORAGING_I, AppliedEffects.LENGTH_VERY_LONG, "Delicious!", -9, Tag.FOOD, Tag.FRUITY, Tag.SWEET, Tag.CUISINE));
            AddToDictionary(BANANA_CHIPS = new EdibleItem("Banana Chips", Paths.ITEM_BANANA_CHIPS, DEFAULT_STACK_SIZE, "Chips made from dried banana slices. Commonly used in trail mix.", AppliedEffects.BUG_CATCHING_I, AppliedEffects.LENGTH_VERY_LONG, "Delicious!", -9, Tag.FOOD, Tag.FRUITY, Tag.SALTY, Tag.SWEET, Tag.CUISINE));
            AddToDictionary(COCONUT_CHIPS = new EdibleItem("Coconut Chips", Paths.ITEM_COCONUT_CHIPS, DEFAULT_STACK_SIZE, "A unique chip made from compressing coconut flesh into discs, then drying.", AppliedEffects.SPEED_I, AppliedEffects.LENGTH_MEDIUM, "Delicious!", -9, Tag.FOOD, Tag.SWEET, Tag.FRUITY, Tag.CUISINE));
            AddToDictionary(CHERRY_RAISINS = new EdibleItem("Cherry Raisins", Paths.ITEM_CHERRY_RAISINS, DEFAULT_STACK_SIZE, "These raisens use cherries instead of grapes.", AppliedEffects.SPEED_I_SPRING, AppliedEffects.LENGTH_LONG, "Delicious!", -9, Tag.FOOD, Tag.SWEET, Tag.FRUITY, Tag.CUISINE));
            AddToDictionary(DRIED_CITRUS = new EdibleItem("Dried Citrus", Paths.ITEM_DRIED_CITRUS, DEFAULT_STACK_SIZE, "Slices of dried citrus. Popular as a snack in tropical places.", AppliedEffects.SPEED_I_SUMMER, AppliedEffects.LENGTH_LONG, "Delicious!", -9, Tag.FOOD, Tag.SWEET, Tag.FRUITY, Tag.CUISINE));
            AddToDictionary(DRIED_OLIVES = new EdibleItem("Dried Olives", Paths.ITEM_DRIED_OLIVES, DEFAULT_STACK_SIZE, "These olives have been preserved by the sun. The flavor is rich and full.", AppliedEffects.SPEED_I_AUTUMN, AppliedEffects.LENGTH_LONG, "Delicious!", -9, Tag.FOOD, Tag.SWEET, Tag.FRUITY, Tag.CUISINE));
            AddToDictionary(DRIED_STRAWBERRY = new EdibleItem("Dried Strawberry", Paths.ITEM_DRIED_STRAWBERRY, DEFAULT_STACK_SIZE, "Dried strawberries! Like normal strawberries, but drier!", AppliedEffects.SPEED_III_SPRING, AppliedEffects.LENGTH_MEDIUM, "Delicious!", -9, Tag.FOOD, Tag.SWEET, Tag.FRUITY, Tag.CUISINE));
            AddToDictionary(WATERLESS_MELON = new EdibleItem("Waterless Melon", Paths.ITEM_WATERLESS_MELON, DEFAULT_STACK_SIZE, "Haha, very funny... ", AppliedEffects.SPEED_III_SUMMER, AppliedEffects.LENGTH_MEDIUM, "Delicious!", -9, Tag.FOOD, Tag.SWEET, Tag.FRUITY, Tag.CUISINE));
            AddToDictionary(POTATO_CRISPS = new EdibleItem("Potato Crisps", Paths.ITEM_POTATO_CRISPS, DEFAULT_STACK_SIZE, "Addictive potato chips! Snacktime has arrived!", AppliedEffects.CHOPPING_II, AppliedEffects.LENGTH_VERY_LONG, "Delicious!", -9, Tag.FOOD, Tag.SWEET, Tag.SALTY, Tag.CUISINE));
            AddToDictionary(SEAWEED_SNACK = new EdibleItem("Seaweed Snack", Paths.ITEM_SEAWEED_SNACK, DEFAULT_STACK_SIZE, "These dried sheets of seaweed have a strong salty flavor.", AppliedEffects.FISHING_II_OCEAN, AppliedEffects.LENGTH_MEDIUM, "Delicious!", -9, Tag.FOOD, Tag.SEAFOOD, Tag.SALTY, Tag.SPICY, Tag.CUISINE));
            AddToDictionary(VEGGIE_CHIPS = new EdibleItem("Veggie Chips", Paths.ITEM_VEGGIE_CHIPS, DEFAULT_STACK_SIZE, "Chips of dried vegetables. Eating healthy never tasted so good!", AppliedEffects.FORAGING_II, AppliedEffects.LENGTH_MEDIUM, "Delicious!", -9, Tag.FOOD, Tag.VEGGIE, Tag.SALTY, Tag.CUISINE));
            ...
            AddToDictionary(TOTEM_OF_THE_CHICKEN = new PlaceableItem("Totem of the Chicken", Paths.ITEM_TOTEM_OF_THE_CHICKEN, Paths.ITEM_TOTEM_OF_THE_CHICKEN, Paths.SPRITE_TOTEM_OF_THE_CHICKEN_SPRITESHEET, Paths.SPRITE_TOTEM_OF_THE_CHICKEN_SPRITESHEET, 1, 4, DEFAULT_STACK_SIZE, "Chickens love this totem. Place it on your farm and chickens will start appearing the next day!", 4000, EntityType.TOTEM_CHICKEN, PlaceableItem.PlacementType.NORMAL, null, Item.Tag.DYEABLE, Item.Tag.PLACEABLE, Item.Tag.NO_TRASH));
            AddToDictionary(TOTEM_OF_THE_COW = new PlaceableItem("Totem of the Cow", Paths.ITEM_TOTEM_OF_THE_COW, Paths.ITEM_TOTEM_OF_THE_COW, Paths.SPRITE_TOTEM_OF_THE_COW_SPRITESHEET, Paths.SPRITE_TOTEM_OF_THE_COW_SPRITESHEET, 1, 4, DEFAULT_STACK_SIZE, "Bovines love this totem. Place it on your farm and cows will start appearing the next day!", 4500, EntityType.TOTEM_COW, PlaceableItem.PlacementType.NORMAL, null, Item.Tag.DYEABLE, Item.Tag.PLACEABLE, Item.Tag.NO_TRASH));
            AddToDictionary(TOTEM_OF_THE_PIG = new PlaceableItem("Totem of the Pig", Paths.ITEM_TOTEM_OF_THE_PIG, Paths.ITEM_TOTEM_OF_THE_PIG, Paths.SPRITE_TOTEM_OF_THE_PIG_SPRITESHEET, Paths.SPRITE_TOTEM_OF_THE_PIG_SPRITESHEET, 1, 4, DEFAULT_STACK_SIZE, "Pigs love this totem. Place it on your farm and pigs will start appearing the next day!", 4300, EntityType.TOTEM_PIG, PlaceableItem.PlacementType.NORMAL, null, Item.Tag.DYEABLE, Item.Tag.PLACEABLE, Item.Tag.NO_TRASH));
            AddToDictionary(TOTEM_OF_THE_SHEEP = new PlaceableItem("Totem of the Sheep", Paths.ITEM_TOTEM_OF_THE_SHEEP, Paths.ITEM_TOTEM_OF_THE_SHEEP, Paths.SPRITE_TOTEM_OF_THE_SHEEP_SPRITESHEET, Paths.SPRITE_TOTEM_OF_THE_SHEEP_SPRITESHEET, 1, 4, DEFAULT_STACK_SIZE, "Sheep love this totem. Place it on your farm and sheep will start appearing the next day!", 4600, EntityType.TOTEM_SHEEP, PlaceableItem.PlacementType.NORMAL, null, Item.Tag.DYEABLE, Item.Tag.PLACEABLE, Item.Tag.NO_TRASH));
            AddToDictionary(TOTEM_OF_THE_DOG = new PlaceableItem("Totem of the Dog", Paths.ITEM_TOTEM_OF_THE_DOG, Paths.ITEM_TOTEM_OF_THE_DOG, Paths.SPRITE_TOTEM_OF_THE_DOG_SPRITESHEET, Paths.SPRITE_TOTEM_OF_THE_DOG_SPRITESHEET, 1, 4, DEFAULT_STACK_SIZE, "Dogs love this totem. Place it on your farm and friends will start appearing the next day! The dog will help you with farmwork.", 5800, EntityType.TOTEM_DOG, PlaceableItem.PlacementType.NORMAL, null, Item.Tag.DYEABLE, Item.Tag.PLACEABLE, Item.Tag.NO_TRASH));
            AddToDictionary(TOTEM_OF_THE_CAT = new PlaceableItem("Totem of the Cat", Paths.ITEM_TOTEM_OF_THE_CAT, Paths.ITEM_TOTEM_OF_THE_CAT, Paths.SPRITE_TOTEM_OF_THE_CAT_SPRITESHEET, Paths.SPRITE_TOTEM_OF_THE_CAT_SPRITESHEET, 1, 4, DEFAULT_STACK_SIZE, "Cats love this totem. Place it on your farm and friends will start appearing the next day! The cat will help you with farmwork.", 5200, EntityType.TOTEM_CAT, PlaceableItem.PlacementType.NORMAL, null, Item.Tag.DYEABLE, Item.Tag.PLACEABLE, Item.Tag.NO_TRASH));
            AddToDictionary(TOTEM_OF_THE_ROOSTER = new PlaceableItem("Totem of the Rooster", Paths.ITEM_TOTEM_OF_THE_ROOSTER, Paths.ITEM_TOTEM_OF_THE_ROOSTER, Paths.SPRITE_TOTEM_OF_THE_ROOSTER_SPRITESHEET, Paths.SPRITE_TOTEM_OF_THE_ROOSTER_SPRITESHEET, 1, 4, DEFAULT_STACK_SIZE, "Roosters love this totem. Place it on your farm and you'll have a natural alarm clock!", 4600, EntityType.TOTEM_ROOSTER, PlaceableItem.PlacementType.NORMAL, null, Item.Tag.DYEABLE, Item.Tag.PLACEABLE, Item.Tag.NO_TRASH));
