...
namespace Plateau.Items
{
    public class ItemDict
    {
        ...
        public static void LoadContent(ContentManager content)
        {
            ...
            AddToDictionary(POTATO_AND_BEET_FRIES = new EdibleItem("Potato and Beet Fries", Paths.ITEM_POTATO_AND_BEET_FRIES, DEFAULT_STACK_SIZE, "The mixture of fried beets and potatoes provides some nice variety to typical potato fries.", AppliedEffects.FORAGING_III, AppliedEffects.LENGTH_SHORT, "Delicious!", -9, Tag.FOOD, Tag.SALTY, Tag.VEGGIE, Tag.BREAKFAST, Tag.CUISINE));
            ...
            AddToDictionary(VANILLA_ICE_CREAM = new EdibleItem("Vanilla Ice Cream", Paths.ITEM_VANILLA_ICE_CREAM, DEFAULT_STACK_SIZE, "Sweet, sugarly, and cold.", AppliedEffects.FORAGING_V_WINTER, AppliedEffects.LENGTH_SHORT, "Delicious!", -9, Tag.FOOD, Tag.SWEET, Tag.CUISINE));
            ...
            AddToDictionary(FRIED_FISH = new EdibleItem("Fried Fish", Paths.ITEM_FRIED_FISH, DEFAULT_STACK_SIZE, "First you fry it, then you fry it some more.", AppliedEffects.FISHING_III_FRESHWATER, AppliedEffects.LENGTH_MEDIUM, "Delicious!", -9, Tag.FOOD, Tag.SEAFOOD, Tag.SALTY, Tag.CUISINE));
            ...
            AddToDictionary(FRIED_OYSTERS = new EdibleItem("Fried Oysters", Paths.ITEM_FRIED_OYSTERS, DEFAULT_STACK_SIZE, "On the half shell!", AppliedEffects.FISHING_III_OCEAN, AppliedEffects.LENGTH_SHORT, "Delicious!", -9, Tag.FOOD, Tag.SALTY, Tag.SEAFOOD, Tag.CUISINE));
            AddToDictionary(SURVIVORS_SURPRISE = new EdibleItem("Survivor's Surprise", Paths.ITEM_SURVIVORS_SURPRISE, DEFAULT_STACK_SIZE, "The surprise is that energy bars made of ants and worms don't actually taste half bad.", AppliedEffects.BUG_CATCHING_III, AppliedEffects.LENGTH_LONG, "Delicious!", -9, Tag.FOOD, Tag.BITTER, Tag.CUISINE));
            ...
            AddToDictionary(CREAMY_SQUID = new EdibleItem("Creamy Squid", Paths.ITEM_CREAMY_SQUID, DEFAULT_STACK_SIZE, "A unique dish of magma squid in cream sauce.", AppliedEffects.FISHING_VI_LAVA, AppliedEffects.LENGTH_MEDIUM, "Delicious!", -9, Tag.FOOD, Tag.SWEET, Tag.SEAFOOD, Tag.CUISINE));
            ...
            AddToDictionary(RATATOUILLE = new EdibleItem("Ratatouille", Paths.ITEM_RATATOUILLE, DEFAULT_STACK_SIZE, "A dish made from stacked eggplant, tomatoes, and peppers. Rats can make it too.", AppliedEffects.BUG_CATCHING_IV, AppliedEffects.LENGTH_MEDIUM, "Delicious!", -9, Tag.FOOD, Tag.SAVORY, Tag.VEGGIE, Tag.CUISINE));
