...
namespace Plateau.Entities
{
    public class PEntityJewelersBench : PlacedEntity, IInteract, IHaveHoveringInterface
    {
        ...
        public PEntityJewelersBench(PartialRecolorSprite sprite, Vector2 tilePosition, PlaceableItem sourceItem, DrawLayer drawLayer) : base(tilePosition, sourceItem, drawLayer, sprite.GetFrameWidth() / 8, sprite.GetFrameHeight() / 8)
        {
